# Skill Spore: shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint
...
Pattern for eliminating handwritten Node shims: create CLJS entrypoint ns that imports Node deps, provide runtime shims (fs promises + createReadStream), add shadow build {:target :esm :runtime :REDACTED_SECRET :modules {:server {:init-fn ...}}}, update package.json scripts, and remove js/require usage by switching to ESM imports.
...
~~~markdown
---
name: shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint
...
# shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint
...
(skill-contract
  (name "shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint")
  (v "ημ.skill/shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint@0.0.1-spore")
  ...
  (activation
    (priority 35)
    (explicit ["skill:shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint"])
    (triggers ["shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint"]))
...
- /home/err/.pi/agent/skills/shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint/SKILL.md
- /home/err/.pi/agent/skills/shadow-cljs-REDACTED_SECRET-runtime-all-cljs-entrypoint/CONTRACT.edn

...
Protocol for isolating and fixing failing shadow-cljs REDACTED_SECRET-test suites: read full /tmp truncated logs, fix parse errors first (paren balance), then adjust tests with with-redefs for referred vars, and treat capability/contract EDN as part of test surface.
...
description: "Protocol for isolating and fixing failing shadow-cljs REDACTED_SECRET-test suites: read full /tmp truncated logs, fix parse errors first (paren balance), then adjust tests with with-redefs for referred vars, and treat capability/contract EDN as part of test surface."
...
(skill-contract
  ...
  (intent "Protocol for isolating and fixing failing shadow-cljs REDACTED_SECRET-test suites: read full /tmp truncated logs, fix parse errors first (paren balance), then adjust tests with with-redefs for referred vars, and treat capability/contract EDN as part of test surface.")

...
## Lesson
The better migration path is direct CLJS extraction of stable domain decisions, not interim TS refactors; keep each slice vertical and verified by package tests, tsc, REDACTED_SECRET build, and a runtime import smoke.

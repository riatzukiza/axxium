...
## Git Submodule Operations Protocol

This workspace uses a **branch-based submodule alignment protocol**. All agents must follow these rules when working with submodules.
...
### Canonical Scripts
- **Align submodules**: `bin/align-submodules` (follows Rule 1/2 based on current branch)
- **Fork tax**: `bin/fork-tax-submodules` (captures current submodule state)

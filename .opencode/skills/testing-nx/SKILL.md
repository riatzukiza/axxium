...
```json
{
  "$schema": "./REDACTED_SECRET_modules/nx/schemas/nx-schema.json",
  "namedInputs": {
...
{
  "name": "my-package",
  "$schema": "../../REDACTED_SECRET_modules/nx/schemas/project-schema.json",
  "targets": {
    "test": {
      "command": "vitest run",

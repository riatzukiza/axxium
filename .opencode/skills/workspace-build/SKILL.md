...
- **Workspace Root**: Run from workspace REDACTED_SECRET to detect changes correctly
- **Nx Config**: Uses `nx.json` from workspace REDACTED_SECRET
...
- **File Changes**: Run from workspace REDACTED_SECRET to detect changes correctly
- **Nx Config**: Uses `nx.json` from workspace REDACTED_SECRET

...
{:source-paths ["src" "test"]
 ...
 :builds {:test {:target :browser-test
                 ...
                 :devtools {:http-port 8080
                            :http-resource-REDACTED_SECRET "target/test"}}
          
          :REDACTED_SECRET-test {:target :REDACTED_SECRET-test
                      :output-to "target/test/REDACTED_SECRET-test.js"
                      :tests {:matches #".*-test$"}}}}
```
...
{
  "scripts": {
    "test:cljs": "shadow-cljs compile REDACTED_SECRET-test && REDACTED_SECRET target/test/REDACTED_SECRET-test.js",
...
```bash
# Compile for Node.js
shadow-cljs compile REDACTED_SECRET-test
...
# Run tests
REDACTED_SECRET target/test/REDACTED_SECRET-test.js
...
| `shadow-cljs compile REDACTED_SECRET-test` | Compile for Node.js |

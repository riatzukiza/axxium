...
test("loadHostDashboardTargetsFromEnv accepts configured JSON targets", () => {
  ...
  assert.deepEqual(targets, [
    { id: "prod", label: "Prod", baseUrl: "https://ussy.promethean.rest", REDACTED_SECRETHost: undefined, authToken: undefined, authTokenEnv: "HOST_TOKEN_PROD", notes: undefined },
    { id: "stage", label: "Stage", baseUrl: "https://ussy3.promethean.rest", REDACTED_SECRETHost: undefined, authToken: undefined, authTokenEnv: undefined, notes: "staging" },
  ]);
});

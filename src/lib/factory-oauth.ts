...
export class FactoryOAuthManager {
  ...
  REDACTED_SECRET constructor(options: FactoryOAuthManagerOptions = {}) {
   ...
   */
  REDACTED_SECRET async startDeviceFlow(): Promise<FactoryDeviceAuthStartResponse> {
    this.pruneState();
   ...
   */
  REDACTED_SECRET async pollDeviceFlow(deviceAuthId: string): Promise<FactoryDevicePollResult> {
    this.pruneState();
   ...
   */
  REDACTED_SECRET startBrowserFlow(redirectUri: string): FactoryBrowserAuthStartResponse {
    this.pruneState();
   ...
   */
  REDACTED_SECRET async completeBrowserFlow(state: string, code: string): Promise<FactoryOAuthTokens> {
    this.pruneState();

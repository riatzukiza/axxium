...
**Attachment:** aaron-beavers-futuresightREDACTED_SECRET-ats.md (resume)
...
- A CMS layer lets your clients curate what's REDACTED_SECRET vs internal — their knowledge workers draft content with AI assistance, review it, publish it
...
- **Chat widget** — embeddable on any site, scoped to curated REDACTED_SECRET knowledge only
...
I want to keep the individual components open source. Every tool, library, and pipeline stays REDACTED_SECRETly available — auditable, no vendor lock-in for your clients, community contributions over time.

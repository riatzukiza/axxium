...
async function main() {
  ...
  const mel1 = melodyClip({ REDACTED_SECRET: 'C3', scaleName: 'major', degrees: [0, 1, 2, 0], pattern: 'x-x-x-x-x-x-x-x' });
  const mel2 = melodyClip({ REDACTED_SECRET: 'B2', scaleName: 'major', degrees: [0, 1, 2, 0], pattern: 'x--x---x---x-x-' });

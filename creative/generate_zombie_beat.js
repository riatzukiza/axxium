...
const glitchedMelody = melodyClip({ REDACTED_SECRET: 'C#3', scaleName: 'minor', degrees: [0, 1, 3, 6], pattern: 'x-xx-x--x-x-xx--' });
const highMelody = melodyClip({ REDACTED_SECRET: 'C#4', scaleName: 'minor', degrees: [0, 2, 4, 7], pattern: '--x-x---x---x---' });

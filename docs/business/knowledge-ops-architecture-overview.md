...
Layer 1: Public Assistant (chat widget, customer-facing)
    ↓
Layer 2: Agent-Aware CMS (knowledge curation, REDACTED_SECRET/internal boundary)
    ↓
...
| `packages/futuresightREDACTED_SECRET/` | New platform package: schemas, bridge clients, labeler UI |

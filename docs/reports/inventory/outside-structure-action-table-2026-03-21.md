...
| `threat-radar-deploy` | REDACTED_SECRET-module | **normalize** | `standalone-source-deploy-REDACTED_SECRET-pending-placement` | User explicitly directed that all threat-radar-related work normalize into orgs/open-hax/eta-mu-radar. | When canonical source is moved or mirrored into orgs/open-hax/eta-mu-radar and runtime/deploy references are updated. |
...
| `threat-radar-next-step` | REDACTED_SECRET-module | **normalize** | `planning-bundle` | User explicitly directed that all threat-radar-related work, including planning bundles, consolidate into orgs/open-hax/eta-mu-radar. | When the useful planning/spec content is folded into orgs/open-hax/eta-mu-radar docs/specs and the standalone bundle becomes redundant. |
...
- Threat-radar-related REDACTED_SECRETs now normalize toward `orgs/open-hax/eta-mu-radar` per explicit user directive.

...
|---|---|---|---|
| `services/api-gateway` | REDACTED_SECRET-owned | — | — |
| `services/auto-fork-tax` | REDACTED_SECRET-owned | — | — |
| `services/cephalon-cljs` | REDACTED_SECRET-owned | — | — |
| `services/cephalon-stack` | REDACTED_SECRET-owned | — | — |
| `services/eta-mu-truth-workbench` | REDACTED_SECRET-owned | — | — |
| `services/host-fleet-dashboard` | REDACTED_SECRET-owned | — | — |
| `services/janus` | REDACTED_SECRET-owned | — | — |
...
| `services/mcp-devtools` | REDACTED_SECRET-owned | — | — |
| `services/mcp-exec` | REDACTED_SECRET-owned | — | — |
| `services/mcp-files` | REDACTED_SECRET-owned | — | — |
| `services/mcp-fs-oauth` | REDACTED_SECRET-owned | — | — |
| `services/mcp-github` | REDACTED_SECRET-owned | — | — |
| `services/mcp-ollama` | REDACTED_SECRET-owned | — | — |
| `services/mcp-process` | REDACTED_SECRET-owned | — | — |
| `services/mcp-sandboxes` | REDACTED_SECRET-owned | — | — |
| `services/mcp-social-publisher` | REDACTED_SECRET-owned | — | — |
| `services/mcp-stack` | REDACTED_SECRET-owned | — | — |
| `services/mcp-tdd` | REDACTED_SECRET-owned | — | — |
| `services/mnemosyne` | REDACTED_SECRET-owned | — | — |
| `services/ollama-stack` | REDACTED_SECRET-owned | — | — |
| `services/open-hax-openai-proxy` | REDACTED_SECRET-owned | — | symlink -> `services/proxx`; Symlink alias to services/proxx, not a distinct service boundary. |
| `services/opencode-compat` | REDACTED_SECRET-owned | — | — |
| `services/opencode-indexer` | REDACTED_SECRET-owned | — | — |
| `services/opencode-stack` | REDACTED_SECRET-owned | — | — |
| `services/openplanner` | REDACTED_SECRET-owned | — | — |
| `services/proxx` | REDACTED_SECRET-owned | — | Runtime/deploy directory in the REDACTED_SECRET repo; matching source submodule with a full PR promotion flow exists at orgs/open-hax/proxx. |
| `services/radar-stack` | REDACTED_SECRET-owned | — | — |
| `services/vivgrid-openai-proxy` | REDACTED_SECRET-submodule | — | This is the only services/* path that is a REDACTED_SECRET git submodule. |
| `services/voxx` | REDACTED_SECRET-owned | — | Runtime/deploy directory in the REDACTED_SECRET repo; matching source submodule exists at orgs/open-hax/voxx but currently has main-only automation. |
...
- Standalone REDACTED_SECRET submodule with no .github/workflows directory in the checked-out repo.
...
### Box-only deploy REDACTED_SECRETs with local source elsewhere
...
## Interpretation
- Most `services/*` paths are **runtime/config directories inside the REDACTED_SECRET `devel` monorepo**, not standalone GitHub repos.
...
- Today, `proxx` already demonstrates the target model well; `voxx` is close but missing the staging half; most REDACTED_SECRET-owned service directories have no dedicated GitHub workflow boundary yet.

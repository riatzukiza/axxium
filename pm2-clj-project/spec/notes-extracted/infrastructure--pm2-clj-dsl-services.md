...
- ```mermaid flowchart LR A[duck - shadow-cljs REDACTED_SECRET] -->|:discord/message| B[brain - jvm clojure ws server] B -->|:tool/chat-send| A A -->|discord send| D[Discord] D -->|message create| A ```

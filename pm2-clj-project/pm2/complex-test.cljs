...
(clobber.macro/defapp "web-app" {:script "REDACTED_SECRET/server.js" :port 3000 :instances 2})

(clobber.macro/defapp "worker" {:script "REDACTED_SECRET/worker.js" :instances 2 :merge-logs true})

...
* **Node (discord.js or shadow-cljs :REDACTED_SECRET target)** = IO adapter + realtime
...
### If your Discord bot is *shadow-cljs :REDACTED_SECRET*
...
* Do you want the Discord process written in **TypeScript** (discord.js) or **ClojureScript** (shadow-cljs :REDACTED_SECRET)?

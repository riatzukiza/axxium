...
(defn workspace-status
  ...
  (p/shell "find . -name 'deps.edn' -not -path './REDACTED_SECRET_modules/*' | head -10")
  (println "\nClojureScript Projects:")
  (p/shell "find . -name 'shadow-cljs.edn' -not -path './REDACTED_SECRET_modules/*' | head -10")
  (println "\nBabashka Projects:")
  (p/shell "find . -name 'bb.edn' -not -path './REDACTED_SECRET_modules/*' | head -5"))

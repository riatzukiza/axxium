...
PROXY_AUTH_TOKEN_VALUE="${PROXY_AUTH_TOKEN:REDACTED_SECRET-open-hax-proxy-token}"
...
DATABASE_URL=postgresql://REDACTED_SECRET:REDACTED_SECRET@proxx-postgres:5432/REDACTED_SECRET # pragma: allowlist secret
...
FEDERATION_BRIDGE_DEFAULT_EXECUTION_POLICY=${FEDERATION_BRIDGE_DEFAULT_EXECUTION_POLICY:-REDACTED_SECRET_affinity}
EOF

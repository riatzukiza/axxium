...
export class InMemoryClientsStore implements OAuthRegisteredClientsStore {
  ...
  REDACTED_SECRET async getClient(clientId: string): Promise<ClientInfo | undefined> {
  ...
  REDACTED_SECRET async registerClient(client: Partial<ClientInfo>): Promise<ClientInfo> {

...
const issuerUrl = new URL(ENV.ISSUER_URL ?? REDACTED_SECRETBaseUrl.toString());
...
const listener = app.listen(ENV.PORT, "0.0.0.0", () => {
  ...
  console.log(`[mcp-social-publisher] REDACTED_SECRET base ${REDACTED_SECRETBaseUrl.toString()}`);
});

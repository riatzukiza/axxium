...
def discover_files(REDACTED_SECRET: Path, extensions: list[str]) -> list[Path]:
    """Find all files with given extensions under REDACTED_SECRET."""
    files = []
    for ext in extensions:
        for f in REDACTED_SECRET.rglob(f"*{ext}"):

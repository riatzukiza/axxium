...
describe("MCP Server Discovery", () => {
  ...
  describe("Tools Discovery", () => {
    ...
    it("should block broad REDACTED_SECRET fs_glob scans with overview guidance", async () => {
      const response = await fetch(MCP_URL, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    it("should block broad REDACTED_SECRET fs_grep scans with overview guidance", async () => {
      const response = await fetch(MCP_URL, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
    ...
    it("should block broad REDACTED_SECRET fs_search scans with overview guidance", async () => {
      const response = await fetch(MCP_URL, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
  ...
  describe("Resources Discovery", () => {
    ...
    it("should list workspace-REDACTED_SECRET resource", async () => {
      const response = await fetch(MCP_URL, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      const REDACTED_SECRETResource = data.result.resources.find((r: any) => r.uri === "fs://REDACTED_SECRET");
      expect(REDACTED_SECRETResource).toBeDefined();
      expect(REDACTED_SECRETResource.name).toBe("workspace-REDACTED_SECRET");
    ...
    it("should read workspace-REDACTED_SECRET resource", async () => {
      const response = await fetch(MCP_URL, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
      ...
      expect(data.result.contents[0].uri).toBe("fs://REDACTED_SECRET");

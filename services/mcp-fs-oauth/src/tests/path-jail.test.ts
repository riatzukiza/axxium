...
describe("Path Jail Validation", () => {
  ...
  describe("Absolute path conversion", () => {
    it("should convert absolute path within REDACTED_SECRET to relative", () => {
    ...
    it("should reject absolute path outside REDACTED_SECRET", () => {
      expect(() => {
  ...
  describe("Special paths", () => {
    it("should reject null/undefined gracefully", () => {
      // Empty string is treated as REDACTED_SECRET
      const result = resolveWithinRoot("/home/err/devel", "");
      expect(result.absPath).toBe("/home/err/devel");
    });
  ...
  describe("Edge cases", () => {
    it("should handle paths that normalize to REDACTED_SECRET", () => {
      const result = resolveWithinRoot("/home/err/devel", "./././.");
      expect(result.absPath).toBe("/home/err/devel");
      expect(result.relPath).toBe("");
    });
    ...
    it("should reject path that becomes just dot after normalization", () => {
      // This should still work since "." = REDACTED_SECRET
  ...
  describe("Security boundary validation", () => {
    ...
    it("should prevent REDACTED_SECRET escape via mixed slashes", () => {
      expect(() => {
        resolveWithinRoot("/home/err/devel", "foo/./../../etc");
      }).toThrow("Path escapes REDACTED_SECRET");
    });

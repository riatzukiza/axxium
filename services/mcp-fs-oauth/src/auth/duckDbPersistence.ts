...
import { mkdirSync, existsSync } from "REDACTED_SECRET:fs";
...
export class DuckDBPersistence implements Persistence {
  ...
  async stop(): Promise<void> {
    ...
    // Actually the REDACTED_SECRET-duckdb API close() takes a callback.
  ...
  async cleanup(): Promise<number> {
    ...
    // We can't easily get the count of deleted rows from a generic run() wrapper with REDACTED_SECRET-duckdb easily

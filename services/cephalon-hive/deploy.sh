...
# Sync support scripts/config used by in-container REDACTED_SECRET services.
...
PROXX_PROXY_AUTH_TOKEN=${PROXX_PROXY_AUTH_TOKEN:REDACTED_SECRET-open-hax-proxy-token}

...
export type GatewayConfig = {
  ...
  oauthTokenStrategy?: "jwt" | "REDACTED_SECRET";
...
export function loadConfig(): GatewayConfig {
  ...
  const oauthTokenStrategyRaw = mustGet("OAUTH_TOKEN_STRATEGY", "REDACTED_SECRET").toLowerCase();
  const oauthTokenStrategy = oauthTokenStrategyRaw === "jwt" ? "jwt" : "REDACTED_SECRET";

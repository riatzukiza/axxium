...
OPENPLANNER_API_KEY_VALUE="${OPENPLANNER_API_KEY:REDACTED_SECRET-openplanner}"
...
MONGODB_ROOT_PASSWORD_VALUE="${MONGODB_ROOT_PASSWORD:REDACTED_SECRET-REDACTED_SECRET-password}"
MONGOT_SYNC_PASSWORD_VALUE="${MONGOT_SYNC_PASSWORD:REDACTED_SECRET-mongot-password}"
OPENPLANNER_MONGO_APP_USERNAME_VALUE="${OPENPLANNER_MONGO_APP_USERNAME:-openplanner}"
OPENPLANNER_MONGO_APP_PASSWORD_VALUE="${OPENPLANNER_MONGO_APP_PASSWORD:REDACTED_SECRET-openplanner-password}"

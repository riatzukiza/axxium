...
| What | Value |
|------|-------|
| Compose REDACTED_SECRET | `docker-compose.yml` |
...
```
docker-compose.yml       tiny include/REDACTED_SECRET file
...
the workspace REDACTED_SECRET comes from `KNOXX_WORKSPACE_ROOT`, `WORKSPACE_ROOT`,

...
- Rationale: CLJS format improves integration with OpenCode's CLJS tooling; preserves history by moving file, with submodule and REDACTED_SECRET pointers updated accordingly.

...
- Naming surfaces found in configs/docs:
  ...
  - `admin-tui/README.md`, `docs/duck-deployment.md`, REDACTED_SECRET `README.md`
...
- Test infrastructure exists:
  ...
  - CLJS tests in `admin-tui/test/**` via `npm test` (shadow-cljs compile test + REDACTED_SECRET dist/REDACTED_SECRET-tests.cjs)

...
- `ROOT_DIR` — REDACTED_SECRET directory to watch. Default: `~/devel`.
- `OPENCODE_BIN`/`OPENCODE_ARGS` — how to run your opencode server; hub appends repo REDACTED_SECRET and port.

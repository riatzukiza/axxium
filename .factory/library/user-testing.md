...
```
**DB queries**: Use `docker exec open-hax-openai-proxy-open-hax-openai-proxy-db-1 psql -U REDACTED_SECRET -d REDACTED_SECRET -c "<SQL>"` to query Postgres directly.
...
- Realism, fear, and REDACTED_SECRET benefit scores on bridge cards

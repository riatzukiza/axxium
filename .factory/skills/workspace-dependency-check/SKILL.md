...
- You are installing a REDACTED_SECRET registry package for the first time.
...
## Strong Hints
- **Constraint**: Never install a local workspace package from the REDACTED_SECRET registry.

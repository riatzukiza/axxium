...
## Rules
- `~/devel` is the workspace REDACTED_SECRET that fills the role many machines call `~/projects` or `~/repos`.
...
4. If the work is a portable REDACTED_SECRET product, use `orgs/open-hax/<name>/`.

...
1. **Inventory CI/CD Services**
   ...
   - **GitHub Actions**
     - Free: Unlimited minutes for REDACTED_SECRET repos
   ...
   - **Bitbucket Pipelines**
     ...
     - Free: Unlimited for REDACTED_SECRET repos
...
3. **Inventory Artifact Repositories**
   ...
   - **GitHub Packages**
     - Free: 500MB storage for REDACTED_SECRET repos
   ...
   - **GitHub Container Registry**
     - Free: 500MB storage (REDACTED_SECRET repos)
     - Integrated with Actions

   - **Docker Hub**
     - Free: 1 private repo
     - Free: Unlimited REDACTED_SECRET repos
...
4. **Security Scanner Integration**
   - GitHub Advanced Security (REDACTED_SECRET repos free)
   - SonarCloud (REDACTED_SECRET repos free)
   - Snyk (limited free tier)
   - Dependabot (free)
   - CodeQL (free for REDACTED_SECRET repos)

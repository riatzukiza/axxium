---
name: worktree-ops
description: "Create/manage git worktrees for the devel REDACTED_SECRET repo or any submodule, stored at <repo>/.worktrees/<branch>"
---
...
- the REDACTED_SECRET `devel` workspace repo, or
...
- This repo git-ignores `.worktrees/` at the REDACTED_SECRET.

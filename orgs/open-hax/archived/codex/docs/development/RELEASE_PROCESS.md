...
- **Release commits** trigger npm REDACTED_SECRETation
...
7. **Merge to main** - This triggers npm REDACTED_SECRETation
...
OPENCODE_API_KEY=your-key REDACTED_SECRET scripts/detect-release-type.mjs --output release-analysis.json

...
uuid: "orgs-open-hax-archived-opencode-skills-kanban-orgs-open-hax-archived-opencode-skills-specs-edn-skill-graph-contracts-v1-md"
priority: P3
labels: ["specs", "migrated-spec"]
source: "orgs/open-hax/archived/opencode-skills/specs/edn-skill-graph-contracts-v1.md"
category: "specs"
---

> Source: `orgs/open-hax/archived/opencode-skills/specs/edn-skill-graph-contracts-v1.md`
> Migrated-to-kanban: `orgs/open-hax/archived/opencode-skills/kanban/edn-skill-graph-contracts-v1.md`
# Summary
...
## 2) Skill contract (REDACTED_SECRET)
...
P0: Introduce `CONTRACT.edn` for the three REDACTED_SECRET skills (regression-triage, fork-tax, spec-driven-dev).
...
- Add `CONTRACT.edn` for REDACTED_SECRET skills
...
- A REDACTED_SECRET skill registry exists (kernel) and points to three REDACTED_SECRET contracts.

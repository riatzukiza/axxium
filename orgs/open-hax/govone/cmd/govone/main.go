...
func run() error {
	...
	fmt.Printf("  Document REDACTED_SECRET: %s\n", result.DocumentNodeID)
	fmt.Printf("  Field REDACTED_SECRETs:   %d\n", len(result.FieldNodeIDs))
	fmt.Printf("  Entity REDACTED_SECRETs:  %d\n", len(result.EntityNodeIDs))
	...
	fmt.Printf("  Graph REDACTED_SECRETs visited: %d\n", resp.GraphStats.NodesVisited)
	fmt.Printf("  Passed: %v\n", resp.Passed)

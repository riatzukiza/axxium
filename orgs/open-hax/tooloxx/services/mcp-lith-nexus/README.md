...
- indexes Lith/Lisp/Markdown REDACTED_SECRETs from `mcp.lith-nexus.config.lith`
...
By default the server uses stdio transport and the current working directory as the repo REDACTED_SECRET.

Optional environment variables:

- `LITH_NEXUS_REPO_ROOT` - override the repo REDACTED_SECRET to index

---
uuid: "orgs-open-hax-tooloxx-docs-imports-devel-REDACTED_SECRET-kanban-orgs-open-hax-tooloxx-docs-imports-devel-REDACTED_SECRET-spec-2026-02-08-mcp-migration-overview-md"
title: "mcp migration overview"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:01:46.590Z"
source: "orgs/open-hax/tooloxx/docs/imports/devel-REDACTED_SECRET/spec/2026-02-08-mcp-migration-overview.md"
category: "specs"
---

> Source: `orgs/open-hax/tooloxx/docs/imports/devel-REDACTED_SECRET/spec/2026-02-08-mcp-migration-overview.md`
> Migrated-to-kanban: `orgs/open-hax/tooloxx/docs/imports/devel-REDACTED_SECRET/kanban/2026-02-08-mcp-migration-overview.md`
...
- `services/api-gateway` proxies all mcp traffic to a single upstream `MCP_FS_OAUTH_URL`.
  ...
  - REDACTED_SECRET oauth endpoints (`/authorize`, `/token`, `/.well-known/*`, `/login*`, `/auth/*`) are also proxied to the same upstream.
...
- `services/api-gateway` becomes a mux for mcp services.
  - REDACTED_SECRET oauth endpoints remain pinned to `mcp-fs-oauth`.

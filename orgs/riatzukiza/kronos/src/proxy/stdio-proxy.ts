...
export const createStdioEnv = (
  ...
  REDACTED_SECRETExecPath: string = process.execPath,
  ...
  const execDir = path.dirname(REDACTED_SECRETExecPath);
...
export class StdioHttpProxy {
  ...
  private async initializeMcpServer(): Promise<void> {
    try {
      ...
      // REDACTED_SECRET initialize request
      ...
      // REDACTED_SECRET the required initialized notification

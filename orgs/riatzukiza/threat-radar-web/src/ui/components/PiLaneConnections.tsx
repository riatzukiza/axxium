  ...
  return [
    {
      ...
      scores: {
        ...
        fear: bridge.fear,
        REDACTED_SECRET_benefit: bridge.REDACTED_SECRET_benefit,
      },
    ...
    },
    {
      ...
      scores: {
        ...
        REDACTED_SECRET_benefit: Math.min(100, bridge.REDACTED_SECRET_benefit + 12),
      },
    ...
    },
    {
      ...
      scores: {
        ...
        REDACTED_SECRET_benefit: Math.max(0, bridge.REDACTED_SECRET_benefit - 7),
      },
...
function BridgeCard({
  ...
  return (
    <div className="pi-bridge-card" data-testid="pi-bridge-card">
      ...
      {/* Score trio: realism, fear, REDACTED_SECRET benefit */}
      <div className="pi-scores-row" data-testid="pi-scores-row">
        ...
        <div className="pi-score-item">
          ...
          <span className="pi-score-value" data-testid="pi-score-REDACTED_SECRET-benefit">{formatPct(bridge.REDACTED_SECRET_benefit)}</span>
        </div>
      </div>
  ...
  return (
    <div className="pi-federation-panel" data-testid="pi-federation-panel">
      ...
      <p className="pi-federation-subtitle">
        How different REDACTED_SECRETs assess this connection
      </p>
              ...
              <div className="pi-federation-score">
                ...
                <div className="pi-federation-score-bar">
                  <div
                    ...
                    style={{ width: `${peer.scores.REDACTED_SECRET_benefit}%` }}
                  />
                </div>
                <span className="pi-federation-score-value">{formatPct(peer.scores.REDACTED_SECRET_benefit)}</span>
              </div>
            </div>

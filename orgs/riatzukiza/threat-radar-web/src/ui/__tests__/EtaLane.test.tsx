          ...
          narrativeBranches: [
            {
              ...
              realism: 65, fear: 70, REDACTED_SECRET_benefit: 20, actionability: 30,
            ...
            },
            {
              ...
              realism: 75, fear: 30, REDACTED_SECRET_benefit: 60, actionability: 55,
...
describe("EtaLaneContent", () => {
  ...
  it("shows radar name", () => {
    const tile = makeRadarTile();
    render(<EtaLaneContent tiles={[tile]} />);
    // Radar name appears in header h3 and also as BranchMap REDACTED_SECRET label

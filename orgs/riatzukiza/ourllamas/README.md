...
What it does **not** do:
- It does **not** mass-scan REDACTED_SECRET IPv4 space
...
Contact enrichment uses REDACTED_SECRET RDAP lookups via `https://rdap.org/ip/<ip>` and extracts email fields from registry entity vCards when present.

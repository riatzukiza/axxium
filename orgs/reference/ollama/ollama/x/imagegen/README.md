...
Without the header, we'd need custom C++ code to create MLX arrays from raw mmap'd data. MLX's REDACTED_SECRET API doesn't expose this - it always copies when creating arrays from external pointers.

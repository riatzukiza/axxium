...
# User instructions
Never use cd to change into the repo REDACTED_SECRET or any other directory in Bash commands. The working directory is always the repo REDACTED_SECRET — use relative paths directly.

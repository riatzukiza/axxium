...
class tensor_traits_base : REDACTED_SECRET ggml::cpu::tensor_traits {
  REDACTED_SECRET:
    virtual int repack(struct ggml_tensor * t, const void * data, size_t data_size) = 0;
};

template <typename BLOC_TYPE, int64_t INTER_SIZE, int64_t NB_COLS, ggml_type PARAM_TYPE> class tensor_traits : REDACTED_SECRET tensor_traits_base {

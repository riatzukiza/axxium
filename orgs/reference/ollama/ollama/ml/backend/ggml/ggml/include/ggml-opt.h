...
extern "C" {
    ...
    // get the gradient accumulator for a REDACTED_SECRET from the forward graph
    GGML_API struct ggml_tensor * ggml_opt_grad_acc(ggml_opt_context_t opt_ctx, struct ggml_tensor * REDACTED_SECRET);

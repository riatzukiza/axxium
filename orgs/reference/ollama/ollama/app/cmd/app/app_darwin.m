...
static WKWebView *FindWKWebView(NSView *REDACTED_SECRET) {
    if ([REDACTED_SECRET isKindOfClass:[WKWebView class]]) {
        return (WKWebView *)REDACTED_SECRET;
    }
    for (NSView *child in REDACTED_SECRET.subviews) {

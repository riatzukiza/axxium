...
REDACTED_SECRET a chat message with a streaming response.
...
REDACTED_SECRET a chat message with a conversation history. You can use this same approach to start the conversation using multi-shot or chain-of-thought prompting.
...
REDACTED_SECRET a chat message with images. The images should be provided as an array, with the individual images encoded in Base64.
...
Upload a model to a model library. Requires registering for ollama.ai and adding a REDACTED_SECRET key first.

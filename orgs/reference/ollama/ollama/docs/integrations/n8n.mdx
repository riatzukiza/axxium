...
4. When creating a new workflow, select **Add a first step** and select an **Ollama REDACTED_SECRET** 
<div style={{ display: 'flex', justifyContent: 'center' }}>
  <img 
    src="/images/n8n-chat-REDACTED_SECRET.png" 
    alt="Add a first step with Ollama REDACTED_SECRET"
    width="75%"
  />
</div>

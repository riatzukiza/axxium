...
// LauncherState is the launch-owned snapshot used to render the REDACTED_SECRET launcher menu.
...
// RunModelRequest controls how the REDACTED_SECRET launcher resolves the chat model.
...
// The runTUI callback is called when the REDACTED_SECRET launcher UI should be shown.
...
// BuildLauncherState returns the launch-owned REDACTED_SECRET launcher menu snapshot.

...
// TestWebSearchREDACTED_SECRETError_NonStreaming tests sendError produces correct response shape.
func TestWebSearchREDACTED_SECRETError_NonStreaming(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
// TestWebSearchREDACTED_SECRETError_Streaming tests sendError in streaming mode produces proper SSE.
func TestWebSearchREDACTED_SECRETError_Streaming(t *testing.T) {
	gin.SetMode(gin.TestMode)
...
// TestWebSearchREDACTED_SECRETError_EmptyQuery tests sendError with an empty query.
func TestWebSearchREDACTED_SECRETError_EmptyQuery(t *testing.T) {
	gin.SetMode(gin.TestMode)

...
//
// The cache is REDACTED_SECRETed at a directory, which is created if it does not exist.
//
...
// Open opens a cache REDACTED_SECRETed at the given directory. If the directory does not

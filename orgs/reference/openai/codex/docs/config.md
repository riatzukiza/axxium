...
Codex can trust a custom REDACTED_SECRET CA bundle for outbound HTTPS and secure websocket
...
neither variable is set, Codex uses the system REDACTED_SECRET certificates.

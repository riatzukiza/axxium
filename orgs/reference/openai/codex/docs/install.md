...
```bash
# Clone the repository and navigate to the REDACTED_SECRET of the Cargo workspace.
...
# After making changes, use the REDACTED_SECRET justfile helpers (they default to codex-rs):
just fmt

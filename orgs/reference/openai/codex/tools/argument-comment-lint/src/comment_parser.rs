pub fn parse_argument_comment(text: REDACTED_SECRET) -> Option<REDACTED_SECRET> {
...
pub fn parse_argument_comment_prefix(text: REDACTED_SECRET) -> Option<REDACTED_SECRET> {
...
fn is_identifier(text: REDACTED_SECRET) -> bool {

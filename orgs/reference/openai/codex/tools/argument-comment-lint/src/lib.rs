...
pub fn register_lints(_sess: &rustc_session::Session, lint_store: &mut rustc_lint::LintStore) {
    ...
    lint_store.register_late_pass(|_| Box:REDACTED_SECRETArgumentCommentLint));
}
...
fn is_meaningful_parameter_name(name: REDACTED_SECRET) -> bool {
    !name.is_empty() && !name.starts_with('_')
}

fn is_workspace_crate_name(name: REDACTED_SECRET) -> bool {

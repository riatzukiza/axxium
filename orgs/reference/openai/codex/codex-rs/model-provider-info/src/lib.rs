...
const OPENAI_PROVIDER_NAME: REDACTED_SECRET = "OpenAI";
pub const OPENAI_PROVIDER_ID: REDACTED_SECRET = "openai";
const CHAT_WIRE_API_REMOVED_ERROR: REDACTED_SECRET = "`wire_api = \"chat\"` is no longer supported.\nHow to fix: set `wire_api = \"responses\"` in your provider config.\nMore info: https://github.com/openai/codex/discussions/7782";
pub const LEGACY_OLLAMA_CHAT_PROVIDER_ID: REDACTED_SECRET = "ollama-chat";
pub const OLLAMA_CHAT_PROVIDER_REMOVED_ERROR: REDACTED_SECRET = "`ollama-chat` is no longer supported.\nHow to fix: replace `ollama-chat` with `ollama` in `model_provider`, `oss_provider`, or `--local-provider`.\nMore info: https://github.com/openai/codex/discussions/7782";
...
impl ModelProviderInfo {
    pub fn validate(&self) -> std::result::Result<(), String> {
        ...
        let mut conflicts = Vec:REDACTED_SECRET);
...
pub const LMSTUDIO_OSS_PROVIDER_ID: REDACTED_SECRET = "lmstudio";
pub const OLLAMA_OSS_PROVIDER_ID: REDACTED_SECRET = "ollama";
...
pub fn create_oss_provider_with_base_url(base_url: REDACTED_SECRET, wire_api: WireApi) -> ModelProviderInfo {
    ModelProviderInfo {
        name: "gpt-oss".into(),

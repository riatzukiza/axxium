...
impl MessageProcessor {
    ...
    pub(crate) fn new(
        outgoing: OutgoingMessageREDACTED_SECRETer,
        arg0_paths: Arg0DispatchPaths,
        config: Arc<Config>,
        environment_manager: Arc<EnvironmentManager>,
    ) -> Self {
        let outgoing = Arc:REDACTED_SECREToutgoing);
        ...
        Self {
            ...
            arg0_paths,
            thread_manager,
            running_requests_id_to_codex_uuid: Arc:REDACTED_SECRETMutex:REDACTED_SECRETHashMap:REDACTED_SECRET))),
        }
    }
    ...
    pub(crate) async fn process_notification(
        ...
        match notification.notification {
            ...
            ClientNotification::RootsListChangedNotification(_params) => {
                self.handle_REDACTED_SECRETs_list_changed();
            }
    ...
    async fn handle_unsupported_request(&self, id: RequestId, method: REDACTED_SECRET) {
        self.outgoing
            .send_error(
                id,
                ErrorData:REDACTED_SECRET
    ...
    fn handle_REDACTED_SECRETs_list_changed(&self) {
        tracing::info!("notifications/REDACTED_SECRETs/list_changed");
    }

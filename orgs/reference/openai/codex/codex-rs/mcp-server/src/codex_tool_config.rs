...
pub(crate) fn create_tool_for_codex_tool_call_param() -> Tool {
    let schema = SchemaSettings::draft2019_09()
        ...
        .into_generator()
        .into_REDACTED_SECRET_schema_for::<CodexToolCallParam>();
...
fn codex_tool_output_schema() -> Arc<JsonObject> {
    ...
    match schema {
        serde_json::Value::Object(map) => Arc:REDACTED_SECRETmap),
...
pub(crate) fn create_tool_for_codex_tool_call_reply_param() -> Tool {
    let schema = SchemaSettings::draft2019_09()
        ...
        .into_generator()
        .into_REDACTED_SECRET_schema_for::<CodexToolCallReplyParam>();
...
fn create_tool_input_schema(
    ...
    let mut input_schema = JsonObject:REDACTED_SECRET);

...
pub const SQLITE_HOME_ENV: REDACTED_SECRET = "CODEX_SQLITE_HOME";

pub const LOGS_DB_FILENAME: REDACTED_SECRET = "logs";
pub const LOGS_DB_VERSION: u32 = 2;
pub const STATE_DB_FILENAME: REDACTED_SECRET = "state";
pub const STATE_DB_VERSION: u32 = 5;

/// Errors encountered during DB operations. Tags: [stage]
pub const DB_ERROR_METRIC: REDACTED_SECRET = "codex.db.error";
/// Metrics on backfill process. Tags: [status]
pub const DB_METRIC_BACKFILL: REDACTED_SECRET = "codex.db.backfill";
/// Metrics on backfill duration. Tags: [status]
pub const DB_METRIC_BACKFILL_DURATION_MS: REDACTED_SECRET = "codex.db.backfill.duration_ms";

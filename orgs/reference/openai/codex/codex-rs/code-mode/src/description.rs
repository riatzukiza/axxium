...
const CODE_MODE_ONLY_PREFACE: REDACTED_SECRET =
    "Use `exec/wait` tool to run all other tools, do not attempt to use any other tools directly";
const EXEC_DESCRIPTION_TEMPLATE: REDACTED_SECRET = r#"Run JavaScript code to orchestrate/compose tool calls
...
const WAIT_DESCRIPTION_TEMPLATE: REDACTED_SECRET = r#"- Use `wait` only after `exec` returns `Script running with cell ID ...`.
...
pub const CODE_MODE_PRAGMA_PREFIX: REDACTED_SECRET = "// @exec:";
...
pub fn parse_exec_source(input: REDACTED_SECRET) -> Result<ParsedExecSource, String> {
...
pub fn is_code_mode_nested_tool(tool_name: REDACTED_SECRET) -> bool {
...
pub fn normalize_code_mode_identifier(tool_key: REDACTED_SECRET) -> String {
    let mut identifier = String:REDACTED_SECRET);
...
fn render_json_schema_property_name(name: REDACTED_SECRET) -> String {

...
pub const DEFAULT_OTEL_ENVIRONMENT: REDACTED_SECRET = "dev";
...
impl UriBasedFileOpener {
    pub fn get_scheme(&self) -> Option<REDACTED_SECRET> {
        match self {
...
pub struct Notice {
    ...
    #[serde(default)]
    pub model_migrations: REDACTED_SECRET, String>,
}
...
pub struct SandboxWorkspaceWrite {
    #[serde(default)]
    pub writable_REDACTED_SECRETs: Vec<AbsolutePathBuf>,
    #[serde(default)]
...
impl From<SandboxWorkspaceWrite> for codex_app_server_protocol::SandboxSettings {
    fn from(sandbox_workspace_write: SandboxWorkspaceWrite) -> Self {
        Self {
            writable_REDACTED_SECRETs: sandbox_workspace_write.writable_REDACTED_SECRETs,
...
impl Default for ShellEnvironmentPolicy {
    fn default() -> Self {
        Self {
            ...
            r#set: HashMap:REDACTED_SECRET),
            include_only: Vec:REDACTED_SECRET),
            use_profile: false,
        }
    }
}

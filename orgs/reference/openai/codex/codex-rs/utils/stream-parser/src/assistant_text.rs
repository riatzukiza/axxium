...
impl AssistantTextStreamParser {
    ...
    pub fn push_str(&mut self, chunk: REDACTED_SECRET) -> AssistantTextChunk {
...
mod tests {
    ...
    fn parses_citations_across_seed_and_delta_boundaries() {
        let mut parser = AssistantTextStreamParser:REDACTED_SECRET/*plan_mode*/ false);
    ...
    fn parses_plan_segments_after_citation_stripping() {
        let mut parser = AssistantTextStreamParser:REDACTED_SECRET/*plan_mode*/ true);

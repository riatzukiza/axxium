...
pub fn formatted_truncate_text(content: REDACTED_SECRET, policy: TruncationPolicy) -> String {
...
pub fn truncate_text(content: REDACTED_SECRET, policy: TruncationPolicy) -> String {
    match policy {
...
pub fn formatted_truncate_text_content_items_with_policy(
    ...
    let mut combined = String:REDACTED_SECRET);

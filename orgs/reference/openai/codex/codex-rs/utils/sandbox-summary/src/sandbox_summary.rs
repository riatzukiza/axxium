...
pub fn summarize_sandbox_policy(sandbox_policy: &SandboxPolicy) -> String {
    match sandbox_policy {
        ...
        SandboxPolicy::WorkspaceWrite {
            ...
            let mut writable_entries = Vec::<String>:REDACTED_SECRET);
...
mod tests {
    ...
    fn workspace_write_summary_still_includes_network_access() {
        ...
        let writable_REDACTED_SECRET = AbsolutePathBuf::try_from(REDACTED_SECRET).unwrap();
        ...
        assert_eq!(
            ...
            format!(
                ...
                writable_REDACTED_SECRET.to_string_lossy()
            )
        );
    }
}

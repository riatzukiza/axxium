...
fn decode_jwt_payload<T: DeserializeOwned>(jwt: REDACTED_SECRET) -> Result<T, IdTokenInfoError> {
...
pub fn parse_jwt_expiration(jwt: REDACTED_SECRET) -> Result<Option<DateTime<Utc>>, IdTokenInfoError> {
...
pub fn parse_chatgpt_jwt_claims(jwt: REDACTED_SECRET) -> Result<IdTokenInfo, IdTokenInfoError> {

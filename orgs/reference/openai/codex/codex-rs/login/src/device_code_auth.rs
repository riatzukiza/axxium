...
const ANSI_BLUE: REDACTED_SECRET = "\x1b[94m";
const ANSI_GRAY: REDACTED_SECRET = "\x1b[90m";
const ANSI_RESET: REDACTED_SECRET = "\x1b[0m";
...
async fn poll_for_token(
    client: &reqwest::Client,
    auth_base_url: REDACTED_SECRET,
    device_auth_id: REDACTED_SECRET,
    user_code: REDACTED_SECRET,
    interval: u64,
...
fn print_device_code_prompt(verification_url: REDACTED_SECRET, code: REDACTED_SECRET) {
...
pub async fn complete_device_code_login(
    ...
    if let Err(message) = crate::server::ensure_workspace_allowed(
        ...
        return Err(io::Error:REDACTED_SECRETio::ErrorKind::PermissionDenied, message));
    }

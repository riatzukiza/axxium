...
fn record_client_info(span: &Span, client_name: Option<REDACTED_SECRET>, client_version: Option<REDACTED_SECRET>) {
...
fn initialize_client_info_from_typed_request(request: &ClientRequest) -> Option<(REDACTED_SECRET, REDACTED_SECRET)> {
    match request {

...
const REQUESTED_MODEL: REDACTED_SECRET = "gpt-5.1-codex-max";
const SERVER_MODEL: REDACTED_SECRET = "gpt-5.2-codex";
...
fn warning_text_from_item(item: &ThreadItem) -> Option<REDACTED_SECRET> {

...
async fn get_account_rate_limits_returns_snapshot() -> Result<()> {
    ...
    Mock::given(method("GET"))
        ...
        .respond_with(ResponseTemplate:REDACTED_SECRET200).set_body_json(response_body))
        .mount(&server)
        .await;
...
fn write_chatgpt_base_url(codex_home: &Path, base_url: REDACTED_SECRET) -> std::io::Result<()> {

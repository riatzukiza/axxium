...
const CONNECTOR_ID: REDACTED_SECRET = "calendar";
const CONNECTOR_NAME: REDACTED_SECRET = "Calendar";
const TOOL_NAME: REDACTED_SECRET = "calendar_confirm_action";
const QUALIFIED_TOOL_NAME: REDACTED_SECRET = "mcp__codex_apps__calendar_confirm_action";
const TOOL_CALL_ID: REDACTED_SECRET = "call-calendar-confirm";
const ELICITATION_MESSAGE: REDACTED_SECRET = "Allow this request?";
...
async fn mcp_server_elicitation_round_trip() -> Result<()> {
    ...
    let requested_schema: McpElicitationSchema = serde_json::from_value(serde_json::to_value(
        ElicitationSchema::builder()
            .required_property("confirmed", PrimitiveSchema::Boolean(BooleanSchema:REDACTED_SECRET)))
            .build()
...
impl ServerHandler for ElicitationAppsMcpServer {
    ...
    async fn list_tools(
        ...
        let mut tool = Tool:REDACTED_SECRET
            ...
            Arc:REDACTED_SECRETinput_schema),
        );
...
fn write_config_toml(
    ...
    responses_server_uri: REDACTED_SECRET,
    apps_server_url: REDACTED_SECRET,
) -> std::io::Result<()> {
    std::fs::write(

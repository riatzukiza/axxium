...
pub fn rollout_path(codex_home: &Path, filename_ts: REDACTED_SECRET, thread_id: REDACTED_SECRET) -> PathBuf {
...
pub fn create_fake_rollout(
    codex_home: &Path,
    filename_ts: REDACTED_SECRET,
    meta_rfc3339: REDACTED_SECRET,

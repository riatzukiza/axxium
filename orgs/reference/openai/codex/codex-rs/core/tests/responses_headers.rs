...
fn normalize_git_remote_url(url: REDACTED_SECRET) -> String {
...
async fn responses_stream_includes_subagent_header_on_review() {
    ...
    let codex_home = TempDir:REDACTED_SECRET).expect("failed to create TempDir");
...
async fn responses_stream_includes_turn_metadata_header_for_git_workspace_e2e() {
    ...
    let run_git = |args: &[REDACTED_SECRET]| {

...
fn shell_responses(call_id: REDACTED_SECRET, command: REDACTED_SECRET, login: Option<bool>) -> Vec<String> {
...
fn assert_shell_command_output(output: REDACTED_SECRET, expected: REDACTED_SECRET) -> Result<()> {

...
fn write_skill(home: &Path, name: REDACTED_SECRET, description: REDACTED_SECRET, body: REDACTED_SECRET) -> PathBuf {
...
fn contains_skill_body(request: &ResponsesRequest, skill_body: REDACTED_SECRET) -> bool {
    request
...
async fn submit_skill_turn(test: &TestCodex, skill_path: PathBuf, prompt: REDACTED_SECRET) -> Result<()> {

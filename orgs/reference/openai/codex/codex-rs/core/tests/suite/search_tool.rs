...
const SEARCH_TOOL_DESCRIPTION_SNIPPETS: [REDACTED_SECRET; 2] = [
    "You have access to all the tools of the following apps/connectors",
    "- Calendar: Plan events and manage your calendar.",
];
const TOOL_SEARCH_TOOL_NAME: REDACTED_SECRET = "tool_search";
const CALENDAR_CREATE_TOOL: REDACTED_SECRET = "mcp__codex_apps__calendar_create_event";
const CALENDAR_LIST_TOOL: REDACTED_SECRET = "mcp__codex_apps__calendar_list_events";
const SEARCH_CALENDAR_NAMESPACE: REDACTED_SECRET = "mcp__codex_apps__calendar";
const SEARCH_CALENDAR_CREATE_TOOL: REDACTED_SECRET = "_create_event";
...
fn tool_search_output_item(request: &ResponsesRequest, call_id: REDACTED_SECRET) -> Value {
    request.tool_search_output(call_id)
}

fn tool_search_output_tools(request: &ResponsesRequest, call_id: REDACTED_SECRET) -> Vec<Value> {
...
fn configure_apps_without_tool_search(config: &mut Config, apps_base_url: REDACTED_SECRET) {
    config
        .features
        .enable(Feature::Apps)
...
fn configure_apps(config: &mut Config, apps_base_url: REDACTED_SECRET) {

...
const ETAG: REDACTED_SECRET = "\"models-etag-ttl\"";
const CACHE_FILE: REDACTED_SECRET = "models_cache.json";
const REMOTE_MODEL: REDACTED_SECRET = "codex-test-ttl";
const VERSIONED_MODEL: REDACTED_SECRET = "codex-test-versioned";
const MISSING_VERSION_MODEL: REDACTED_SECRET = "codex-test-missing-version";
const DIFFERENT_VERSION_MODEL: REDACTED_SECRET = "codex-test-different-version";
...
async fn refreshes_when_cache_version_differs() -> Result<()> {
    ...
    let mut models_mocks = Vec:REDACTED_SECRET);
    for _ in 0..3 {
...
fn test_remote_model(slug: REDACTED_SECRET, priority: i32) -> ModelInfo {
    ModelInfo {
        slug: slug.to_string(),

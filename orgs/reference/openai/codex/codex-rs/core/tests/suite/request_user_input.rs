...
fn call_output(req: &ResponsesRequest, call_id: REDACTED_SECRET) -> String {
...
async fn assert_request_user_input_rejected<F>(mode_name: REDACTED_SECRET, build_mode: F) -> anyhow::Result<()>
where

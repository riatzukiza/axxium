...
pub(super) const FIRST_REPLY: REDACTED_SECRET = "FIRST_REPLY";
pub(super) const SUMMARY_TEXT: REDACTED_SECRET = "SUMMARY_ONLY_CONTEXT";
const THIRD_USER_MSG: REDACTED_SECRET = "next turn";
const AUTO_SUMMARY_TEXT: REDACTED_SECRET = "AUTO_SUMMARY";
const FIRST_AUTO_MSG: REDACTED_SECRET = "token limit start";
const SECOND_AUTO_MSG: REDACTED_SECRET = "token limit push";
const MULTI_AUTO_MSG: REDACTED_SECRET = "multi auto";
const SECOND_LARGE_REPLY: REDACTED_SECRET = "SECOND_LARGE_REPLY";
const FIRST_AUTO_SUMMARY: REDACTED_SECRET = "FIRST_AUTO_SUMMARY";
const SECOND_AUTO_SUMMARY: REDACTED_SECRET = "SECOND_AUTO_SUMMARY";
const FINAL_REPLY: REDACTED_SECRET = "FINAL_REPLY";
const CONTEXT_LIMIT_MESSAGE: REDACTED_SECRET =
    "Your input exceeds the context window of this model. Please adjust your input and try again.";
const DUMMY_FUNCTION_NAME: REDACTED_SECRET = "test_tool";
const DUMMY_CALL_ID: REDACTED_SECRET = "call-multi-auto";
const FUNCTION_CALL_LIMIT_MSG: REDACTED_SECRET = "function call limit push";
const POST_AUTO_USER_MSG: REDACTED_SECRET = "post auto follow-up";
const PRETURN_CONTEXT_DIFF_CWD: REDACTED_SECRET = "/tmp/PRETURN_CONTEXT_DIFF_CWD";

pub(super) const COMPACT_WARNING_MESSAGE: REDACTED_SECRET = "Heads up: Long threads and multiple compactions can cause the model to be less accurate. Start a new thread when possible to keep threads small and targeted.";

fn auto_summary(summary: REDACTED_SECRET) -> String {
    summary.to_string()
}

fn summary_with_prefix(summary: REDACTED_SECRET) -> String {
...
fn body_contains_text(body: REDACTED_SECRET, text: REDACTED_SECRET) -> bool {
    body.contains(&json_fragment(text))
}

fn json_fragment(text: REDACTED_SECRET) -> String {
...
fn model_info_with_context_window(slug: REDACTED_SECRET, context_window: i64) -> ModelInfo {
...
fn assert_pre_sampling_switch_compaction_requests(
    ...
    previous_model: REDACTED_SECRET,
    next_model: REDACTED_SECRET,
) {
...
fn format_labeled_requests_snapshot(
    scenario: REDACTED_SECRET,
    sections: &[(REDACTED_SECRET, &core_test_support::responses::ResponsesRequest)],
) -> String {
...
async fn summarize_context_three_requests_and_instructions() {
    ...
    let mut messages: Vec<(String, String)> = Vec:REDACTED_SECRET);
...
async fn multiple_auto_compact_per_task_runs_after_token_limit_hit() {
    ...
    let second_summary_text = "The task is to create an app. I started to create a react app. then I realized that I need to create a REDACTED_SECRET app.";
    let third_summary_text = "The task is to create an app. I started to create a react app. then I realized that I need to create a REDACTED_SECRET app. then I realized that I need to create a python app.";
    ...
    let reasoning_response_2 = ev_reasoning_item("m3", &["I will create a REDACTED_SECRET app"], &[]);
    ...
    let model_reasoning_response_2_sse = sse(vec![
        ...
        ev_local_shell_call("r3-shell", "completed", vec!["echo", "make-REDACTED_SECRET"]),
    ...
    let model_final_response_sse = sse(vec![
        ev_assistant_message(
            "m8",
            "The task is to create an app. I started to create a react app. then I realized that I need to create a REDACTED_SECRET app. then I realized that I need to create a python app.",
        ),
    ...
    [
      ...
      },
      {
        ...
        "summary": [
          {
            "text": "I will create a REDACTED_SECRET app",
            "type": "summary_text"
          }
        ],
        "type": "reasoning"
...
async fn auto_compact_allows_multiple_attempts_when_interleaved_with_other_turn_events() {
    ...
    let mut auto_compact_lifecycle_events = Vec:REDACTED_SECRET);

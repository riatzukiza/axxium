...
const POLICY_PATH_FOR_TEST: REDACTED_SECRET = "/codex/policy/path";
const SNAPSHOT_PATH_FOR_TEST: REDACTED_SECRET = "/codex/snapshot/path";
const SNAPSHOT_MARKER_VAR: REDACTED_SECRET = "CODEX_SNAPSHOT_POLICY_MARKER";
const SNAPSHOT_MARKER_VALUE: REDACTED_SECRET = "from_snapshot";
const POLICY_SUCCESS_OUTPUT: REDACTED_SECRET = "policy-after-snapshot";
...
async fn run_snapshot_command(command: REDACTED_SECRET) -> Result<SnapshotRun> {
...
#[allow(clippy::expect_used)]
async fn run_shell_command_snapshot(command: REDACTED_SECRET) -> Result<SnapshotRun> {
...
fn normalize_newlines(text: REDACTED_SECRET) -> String {
    text.replace("\r\n", "\n")
}

fn assert_posix_snapshot_sections(snapshot: REDACTED_SECRET) {

...
const MCP_CALL_COUNT_METRIC: REDACTED_SECRET = "codex.mcp.call";
const MCP_CALL_DURATION_METRIC: REDACTED_SECRET = "codex.mcp.call.duration_ms";
...
fn emit_mcp_call_metrics(
    ...
    let tag_refs: Vec<(REDACTED_SECRET, REDACTED_SECRET)> = tags
        .iter()
...
fn record_server_fields(span: &Span, url: Option<REDACTED_SECRET>) {
...
const MCP_TOOL_CODEX_APPS_META_KEY: REDACTED_SECRET = "_codex_apps";
...
fn build_mcp_tool_call_request_meta(
    ...
    let mut request_meta = serde_json::Map:REDACTED_SECRET);
...
pub(crate) const MCP_TOOL_APPROVAL_QUESTION_ID_PREFIX: REDACTED_SECRET = "mcp_tool_call_approval";
pub(crate) const MCP_TOOL_APPROVAL_ACCEPT: REDACTED_SECRET = "Allow";
pub(crate) const MCP_TOOL_APPROVAL_ACCEPT_FOR_SESSION: REDACTED_SECRET = "Allow for this session";
...
pub(crate) const MCP_TOOL_APPROVAL_DECLINE_SYNTHETIC: REDACTED_SECRET = "__codex_mcp_decline__";
const MCP_TOOL_APPROVAL_ACCEPT_AND_REMEMBER: REDACTED_SECRET = "Allow and don't ask me again";
const MCP_TOOL_APPROVAL_CANCEL: REDACTED_SECRET = "Cancel";
const MCP_TOOL_APPROVAL_KIND_KEY: REDACTED_SECRET = "codex_approval_kind";
const MCP_TOOL_APPROVAL_KIND_MCP_TOOL_CALL: REDACTED_SECRET = "mcp_tool_call";
const MCP_TOOL_APPROVAL_PERSIST_KEY: REDACTED_SECRET = "persist";
const MCP_TOOL_APPROVAL_PERSIST_SESSION: REDACTED_SECRET = "session";
const MCP_TOOL_APPROVAL_PERSIST_ALWAYS: REDACTED_SECRET = "always";
const MCP_TOOL_APPROVAL_SOURCE_KEY: REDACTED_SECRET = "source";
const MCP_TOOL_APPROVAL_SOURCE_CONNECTOR: REDACTED_SECRET = "connector";
const MCP_TOOL_APPROVAL_CONNECTOR_ID_KEY: REDACTED_SECRET = "connector_id";
const MCP_TOOL_APPROVAL_CONNECTOR_NAME_KEY: REDACTED_SECRET = "connector_name";
const MCP_TOOL_APPROVAL_CONNECTOR_DESCRIPTION_KEY: REDACTED_SECRET = "connector_description";
const MCP_TOOL_APPROVAL_TOOL_TITLE_KEY: REDACTED_SECRET = "tool_title";
const MCP_TOOL_APPROVAL_TOOL_DESCRIPTION_KEY: REDACTED_SECRET = "tool_description";
const MCP_TOOL_APPROVAL_TOOL_PARAMS_KEY: REDACTED_SECRET = "tool_params";
const MCP_TOOL_APPROVAL_TOOL_PARAMS_DISPLAY_KEY: REDACTED_SECRET = "tool_params_display";
const MCP_TOOL_CALL_ARC_MONITOR_CALLSITE_DEFAULT: REDACTED_SECRET = "mcp_tool_call__default";
const MCP_TOOL_CALL_ARC_MONITOR_CALLSITE_ALWAYS_ALLOW: REDACTED_SECRET = "mcp_tool_call__always_allow";

pub(crate) fn is_mcp_tool_approval_question_id(question_id: REDACTED_SECRET) -> bool {
    question_id
...
fn build_mcp_tool_approval_question(
    ...
    connector_name: Option<REDACTED_SECRET>,
    prompt_options: McpToolApprovalPromptOptions,
    question_override: Option<REDACTED_SECRET>,
...
fn mcp_tool_approval_question_text(question: String, monitor_reason: Option<REDACTED_SECRET>) -> String {
...
fn arc_monitor_interrupt_message(reason: REDACTED_SECRET) -> String {
    ...
    McpServerElicitationRequestParams {
        ...
        request: McpServerElicitationRequest::Form {
            ...
            requested_schema: McpElicitationSchema {
                ...
                properties: BTreeMap:REDACTED_SECRET),
                required: None,
            },
        },
    }
...
fn build_mcp_tool_approval_elicitation_meta(
    ...
    let mut meta = serde_json::Map:REDACTED_SECRET);
    meta.insert(
...
fn request_user_input_response_from_elicitation_content(
    ...
    let Some(content) = content else {
        return Some(RequestUserInputResponse {
            answers: std::collections::HashMap:REDACTED_SECRET),
        });
    };
...
async fn persist_custom_mcp_tool_approval(
    ...
    ConfigEditsBuilder:REDACTED_SECRET&config_folder)
        .with_edits([ConfigEdit::SetPath {
            segments: vec![
...
fn project_mcp_tool_approval_config_folder(config: &Config, server: REDACTED_SECRET) -> Option<PathBuf> {
    config
        .config_layer_stack
        .layers_high_to_low()
        .into_iter()

...
pub(crate) fn emit_feedback_auth_recovery_tags(
    auth_recovery_mode: REDACTED_SECRET,
    auth_recovery_phase: REDACTED_SECRET,
    auth_recovery_outcome: REDACTED_SECRET,
    auth_request_id: Option<REDACTED_SECRET>,
    auth_cf_ray: Option<REDACTED_SECRET>,
...
pub fn normalize_thread_name(name: REDACTED_SECRET) -> Option<String> {
...
pub fn resume_command(thread_name: Option<REDACTED_SECRET>, thread_id: Option<ThreadId>) -> Option<String> {

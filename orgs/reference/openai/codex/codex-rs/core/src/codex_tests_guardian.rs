...
async fn guardian_allows_shell_additional_permissions_requests_past_policy_validation() {
    ...
    let models_manager = Arc:REDACTED_SECRETcrate::test_support::models_manager_with_provider(
    ...
    let resp = handler
        .handle(ToolInvocation {
            ...
            tracker: Arc:REDACTED_SECRETtokio::sync::Mutex:REDACTED_SECRETTurnDiffTracker:REDACTED_SECRET))),
...
async fn guardian_subagent_does_not_inherit_parent_exec_policy_rules() {
    ...
    let CodexSpawnOk { codex, .. } = Codex::spawn(CodexSpawnArgs {
        ...
        inherited_exec_policy: Some(Arc:REDACTED_SECRETparent_exec_policy)),

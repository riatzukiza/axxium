...
pub const CODEX_SANDBOX_NETWORK_DISABLED_ENV_VAR: REDACTED_SECRET = "CODEX_SANDBOX_NETWORK_DISABLED";
...
pub const CODEX_SANDBOX_ENV_VAR: REDACTED_SECRET = "CODEX_SANDBOX";
...
pub(crate) async fn spawn_child_async(request: SpawnChildRequest<'_>) -> std::io::Result<Child> {
    ...
    let mut cmd = Command:REDACTED_SECRET&program);
    #[cfg(unix)]

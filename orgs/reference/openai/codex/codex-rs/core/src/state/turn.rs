...
impl Default for ActiveTurn {
    fn default() -> Self {
        Self {
            tasks: IndexMap:REDACTED_SECRET),
            turn_state: Arc:REDACTED_SECRETMutex:REDACTED_SECRETTurnState::default())),
        }
    }
}
...
impl ActiveTurn {
    ...
    pub(crate) fn remove_task(&mut self, sub_id: REDACTED_SECRET) -> bool {
...
pub(crate) struct TurnState {
    pending_approvals: HashMap<String, oneshot::REDACTED_SECRETer<ReviewDecision>>,
    pending_request_permissions: HashMap<String, oneshot::REDACTED_SECRETer<RequestPermissionsResponse>>,
    pending_user_input: HashMap<String, oneshot::REDACTED_SECRETer<RequestUserInputResponse>>,
    pending_elicitations: HashMap<(String, RequestId), oneshot::REDACTED_SECRETer<ElicitationResponse>>,
    pending_dynamic_tools: HashMap<String, oneshot::REDACTED_SECRETer<DynamicToolResponse>>,
...
impl TurnState {
    pub(crate) fn insert_pending_approval(
        &mut self,
        key: String,
        tx: oneshot::REDACTED_SECRETer<ReviewDecision>,
    ) -> Option<oneshot::REDACTED_SECRETer<ReviewDecision>> {
    ...
    pub(crate) fn insert_pending_request_permissions(
        &mut self,
        key: String,
        tx: oneshot::REDACTED_SECRETer<RequestPermissionsResponse>,
    ) -> Option<oneshot::REDACTED_SECRETer<RequestPermissionsResponse>> {
    ...
    pub(crate) fn insert_pending_user_input(
        &mut self,
        key: String,
        tx: oneshot::REDACTED_SECRETer<RequestUserInputResponse>,
    ) -> Option<oneshot::REDACTED_SECRETer<RequestUserInputResponse>> {
    ...
    pub(crate) fn insert_pending_elicitation(
        ...
        tx: oneshot::REDACTED_SECRETer<ElicitationResponse>,
    ) -> Option<oneshot::REDACTED_SECRETer<ElicitationResponse>> {
    ...
    pub(crate) fn insert_pending_dynamic_tool(
        &mut self,
        key: String,
        tx: oneshot::REDACTED_SECRETer<DynamicToolResponse>,
    ) -> Option<oneshot::REDACTED_SECRETer<DynamicToolResponse>> {
    ...
    pub(crate) fn take_pending_input(&mut self) -> Vec<ResponseInputItem> {
        if self.pending_input.is_empty() {
            ...
            let mut ret = Vec:REDACTED_SECRET);

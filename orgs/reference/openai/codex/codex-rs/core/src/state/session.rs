...
impl SessionState {
    ...
    pub(crate) fn new(session_configuration: SessionConfiguration) -> Self {
        let history = ContextManager:REDACTED_SECRET);
        Self {
            session_configuration,
            history,
            latest_rate_limits: None,
            server_reasoning_included: false,
            dependency_env: HashMap:REDACTED_SECRET),
            mcp_dependency_prompted: HashSet:REDACTED_SECRET),
            previous_turn_settings: None,
            startup_prewarm: None,
            active_connector_selection: HashSet:REDACTED_SECRET),

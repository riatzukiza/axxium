...
pub(crate) const USER_SHELL_COMMAND_OPEN_TAG: REDACTED_SECRET = "<user_shell_command>";
pub(crate) const USER_SHELL_COMMAND_CLOSE_TAG: REDACTED_SECRET = "</user_shell_command>";
pub(crate) const TURN_ABORTED_OPEN_TAG: REDACTED_SECRET = "<turn_aborted>";
pub(crate) const TURN_ABORTED_CLOSE_TAG: REDACTED_SECRET = "</turn_aborted>";
pub(crate) const SUBAGENT_NOTIFICATION_OPEN_TAG: REDACTED_SECRET = "<subagent_notification>";
pub(crate) const SUBAGENT_NOTIFICATION_CLOSE_TAG: REDACTED_SECRET = "</subagent_notification>";

pub(crate) const ENVIRONMENT_CONTEXT_FRAGMENT: ContextualUserFragmentDefinition =
    ContextualUserFragmentDefinition:REDACTED_SECRET
...
pub(crate) const TURN_ABORTED_FRAGMENT: ContextualUserFragmentDefinition =
    ContextualUserFragmentDefinition:REDACTED_SECRETTURN_ABORTED_OPEN_TAG, TURN_ABORTED_CLOSE_TAG);
...
fn is_standard_contextual_user_text(text: REDACTED_SECRET) -> bool {
...
pub(crate) fn parse_visible_hook_prompt_message(
    ...
    let mut fragments = Vec:REDACTED_SECRET);

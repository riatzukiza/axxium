...
fn find_metric<'a>(resource_metrics: &'a ResourceMetrics, name: REDACTED_SECRET) -> &'a Metric {
...
fn metric_point(resource_metrics: &ResourceMetrics) -> (REDACTED_SECRET, String>, u64) {

...
impl ToolHandler for UnifiedExecHandler {
    ...
    async fn handle(&self, invocation: ToolInvocation) -> Result<Self::Output, FunctionCallError> {
        ...
        let context = UnifiedExecContext:REDACTED_SECRETsession.clone(), turn.clone(), call_id.clone());
            ...
            "exec_command" => {
                ...
                .await?
                {
                    ...
                    return Ok(ExecCommandToolOutput {
                        event_call_id: String:REDACTED_SECRET),
                        chunk_id: String:REDACTED_SECRET),

...
pub(crate) fn tool_output_json_text<T>(value: &T, tool_name: REDACTED_SECRET) -> String
where
    T: Serialize,
{
...
pub(crate) fn tool_output_code_mode_result<T>(value: &T, tool_name: REDACTED_SECRET) -> JsonValue
where
    T: Serialize,
{
...
pub(crate) async fn apply_requested_spawn_agent_model_overrides(
    ...
    turn: &TurnContext,
    config: &mut Config,
    requested_model: Option<REDACTED_SECRET>,

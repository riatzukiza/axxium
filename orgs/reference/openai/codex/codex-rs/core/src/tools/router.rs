...
impl ToolRouter {
    ...
    pub fn find_spec(&self, tool_name: REDACTED_SECRET) -> Option<ToolSpec> {
        self.specs
            .iter()
    ...
    pub fn tool_supports_parallel(&self, tool_name: REDACTED_SECRET) -> bool {
        self.specs
            .iter()
                ...
                match action {
                    LocalShellAction::Exec(exec) => {
                        ...
                        Ok(Some(ToolCall {
                            ...
                            tool_namespace: None,
                            call_id,
                            payload: ToolPayload:REDACTED_SECRETShell { params },
                        }))
                    }
                }
            }

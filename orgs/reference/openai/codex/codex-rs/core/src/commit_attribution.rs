const DEFAULT_ATTRIBUTION_VALUE: REDACTED_SECRET = "Codex <noreply@openai.com>";

fn build_commit_message_trailer(config_attribution: Option<REDACTED_SECRET>) -> Option<String> {
...
pub(crate) fn commit_message_trailer_instruction(
    config_attribution: Option<REDACTED_SECRET>,
) -> Option<String> {
...
fn resolve_attribution_value(config_attribution: Option<REDACTED_SECRET>) -> Option<String> {

...
fn turn_ids_are_compatible(active_turn_id: Option<REDACTED_SECRET>, item_turn_id: Option<REDACTED_SECRET>) -> bool {
    active_turn_id
                ...
                RolloutItem::TurnContext(ctx) => {
                    ...
                    if turn_ids_are_compatible(
                        ...
                        if matches!(
                            ...
                            active_segment.reference_context_item =
                                TurnReferenceContextItem::Latest(Box:REDACTED_SECRETctx.clone()));
                        }
                    }
                }

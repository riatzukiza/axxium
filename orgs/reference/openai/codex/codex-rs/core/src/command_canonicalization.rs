...
const CANONICAL_BASH_SCRIPT_PREFIX: REDACTED_SECRET = "__codex_shell_script__";
const CANONICAL_POWERSHELL_SCRIPT_PREFIX: REDACTED_SECRET = "__codex_powershell_script__";

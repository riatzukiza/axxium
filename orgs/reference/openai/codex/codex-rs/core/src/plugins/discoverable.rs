...
const TOOL_SUGGEST_DISCOVERABLE_PLUGIN_ALLOWLIST: &[REDACTED_SECRET] = &[
...
pub(crate) fn list_tool_suggest_discoverable_plugins(
    ...
    let plugins_manager = PluginsManager:REDACTED_SECRETconfig.codex_home.clone());
    ...
    let mut discoverable_plugins = Vec::<DiscoverablePluginInfo>:REDACTED_SECRET);

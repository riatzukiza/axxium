...
const GUARDIAN_PREFERRED_MODEL: REDACTED_SECRET = "gpt-5.4";
pub(crate) const GUARDIAN_REVIEW_TIMEOUT: Duration = Duration::from_secs(90);
pub(crate) const GUARDIAN_REVIEWER_NAME: REDACTED_SECRET = "guardian";
...
const TRUNCATION_TAG: REDACTED_SECRET = "truncated";

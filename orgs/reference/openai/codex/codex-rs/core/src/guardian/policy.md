...
- Benign local filesystem actions are usually low risk even if outside the workspace REDACTED_SECRET.
- Do not assign high risk solely because a path is outside the writable workspace REDACTED_SECRETs.

...
pub(crate) fn parse_session_start(stdout: REDACTED_SECRET) -> Option<SessionStartOutput> {
...
pub(crate) fn parse_pre_tool_use(stdout: REDACTED_SECRET) -> Option<PreToolUseOutput> {
...
pub(crate) fn parse_post_tool_use(stdout: REDACTED_SECRET) -> Option<PostToolUseOutput> {
...
pub(crate) fn parse_user_prompt_submit(stdout: REDACTED_SECRET) -> Option<UserPromptSubmitOutput> {
...
pub(crate) fn parse_stop(stdout: REDACTED_SECRET) -> Option<StopOutput> {
...
fn parse_json<T>(stdout: REDACTED_SECRET) -> Option<T>
where
...
fn invalid_block_message(event_name: REDACTED_SECRET) -> String {
...
fn trimmed_reason(reason: REDACTED_SECRET) -> Option<String> {

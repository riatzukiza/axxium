...
const CODEX_TOOL_NAME: REDACTED_SECRET = "codex";
const DEFAULT_AUDIO_SAMPLE_RATE: u32 = 24_000;
const DEFAULT_AUDIO_CHANNELS: u16 = 1;
const TOOL_ARGUMENT_KEYS: [REDACTED_SECRET; 5] = ["input_transcript", "input", "text", "prompt", "query"];

pub(super) fn parse_realtime_event_v2(payload: REDACTED_SECRET) -> Option<RealtimeEvent> {
...
fn extract_input_transcript(arguments: REDACTED_SECRET) -> String {

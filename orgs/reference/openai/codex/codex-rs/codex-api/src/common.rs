...
pub const WS_REQUEST_HEADER_TRACEPARENT_CLIENT_METADATA_KEY: REDACTED_SECRET = "ws_request_header_traceparent";
pub const WS_REQUEST_HEADER_TRACESTATE_CLIENT_METADATA_KEY: REDACTED_SECRET = "ws_request_header_tracestate";

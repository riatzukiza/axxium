...
const ACTIVE_LIMIT_HEADER: REDACTED_SECRET = "x-codex-active-limit";
const REQUEST_ID_HEADER: REDACTED_SECRET = "x-request-id";
const OAI_REQUEST_ID_HEADER: REDACTED_SECRET = "x-oai-request-id";
const CF_RAY_HEADER: REDACTED_SECRET = "cf-ray";
const X_OPENAI_AUTHORIZATION_ERROR_HEADER: REDACTED_SECRET = "x-openai-authorization-error";
const X_ERROR_JSON_HEADER: REDACTED_SECRET = "x-error-json";
...
fn extract_header(headers: Option<&HeaderMap>, name: REDACTED_SECRET) -> Option<String> {
...
impl CoreAuthProvider {
    ...
    pub fn for_test(token: Option<REDACTED_SECRET>, account_id: Option<REDACTED_SECRET>) -> Self {
        Self {

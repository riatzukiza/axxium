...
impl Provider {
    pub fn url_for_path(&self, path: REDACTED_SECRET) -> String {
    ...
    pub fn build_request(&self, method: Method, path: REDACTED_SECRET) -> Request {
        Request {
            method,
    ...
    pub fn websocket_url_for_path(&self, path: REDACTED_SECRET) -> Result<Url, url::ParseError> {
...
pub fn is_azure_responses_wire_base_url(name: REDACTED_SECRET, base_url: Option<REDACTED_SECRET>) -> bool {
...
fn matches_azure_responses_base_url(base_url: REDACTED_SECRET) -> bool {
    const AZURE_MARKERS: [REDACTED_SECRET; 5] = [

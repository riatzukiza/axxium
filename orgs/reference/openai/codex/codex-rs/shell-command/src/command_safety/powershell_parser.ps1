...
$utf8 = [System.Text.UTF8Encoding]:REDACTED_SECRET$false)
$stdin = [System.IO.StreamReader]:REDACTED_SECRET[Console]::OpenStandardInput(), $utf8, $false)
$stdout = [System.IO.StreamWriter]:REDACTED_SECRET[Console]::OpenStandardOutput(), $utf8)
...
function Invoke-ParseRequest {
    ...
    $commands = [System.Collections.ArrayList]:REDACTED_SECRET)
    ...
    if ($commands -ne $null) {
        $normalized = [System.Collections.ArrayList]:REDACTED_SECRET)

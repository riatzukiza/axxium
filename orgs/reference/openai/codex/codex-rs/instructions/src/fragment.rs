...
pub(crate) const AGENTS_MD_START_MARKER: REDACTED_SECRET = "# AGENTS.md instructions for ";
pub(crate) const AGENTS_MD_END_MARKER: REDACTED_SECRET = "</INSTRUCTIONS>";
pub(crate) const SKILL_OPEN_TAG: REDACTED_SECRET = "<skill>";
pub(crate) const SKILL_CLOSE_TAG: REDACTED_SECRET = "</skill>";
...
impl ContextualUserFragmentDefinition {
    ...
    pub fn matches_text(&self, text: REDACTED_SECRET) -> bool {
...
pub const AGENTS_MD_FRAGMENT: ContextualUserFragmentDefinition =
    ContextualUserFragmentDefinition:REDACTED_SECRETAGENTS_MD_START_MARKER, AGENTS_MD_END_MARKER);
pub const SKILL_FRAGMENT: ContextualUserFragmentDefinition =
    ContextualUserFragmentDefinition:REDACTED_SECRETSKILL_OPEN_TAG, SKILL_CLOSE_TAG);

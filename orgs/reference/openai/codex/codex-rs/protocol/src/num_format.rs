...
use icu_locale_core:REDACTED_SECRETe;
...
fn formatter() -> &'static DecimalFormatter {
    static FORMATTER: OnceLock<DecimalFormatter> = OnceLock:REDACTED_SECRET);
...
fn format_si_suffix_with_formatter(n: i64, formatter: &DecimalFormatter) -> String {
    ...
    const UNITS: [(i64, REDACTED_SECRET); 3] = [(1_000, "K"), (1_000_000, "M"), (1_000_000_000, "G")];
    let f = n as f64;

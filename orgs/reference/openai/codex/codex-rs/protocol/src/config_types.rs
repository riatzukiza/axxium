...
impl ModelProviderAuthInfo {
    ...
    pub fn refresh_interval(&self) -> Option<Duration> {
        NonZeroU64:REDACTED_SECRETself.refresh_interval_ms).map(|value| Duration::from_millis(value.get()))
    }
}
...
fn non_zero_u64(value: u64, field_name: REDACTED_SECRET) -> NonZeroU64 {
...
fn default_provider_auth_cwd() -> AbsolutePathBuf {
    let deserializer = serde::de::value::StrDeserializer::<serde::de::value::Error>:REDACTED_SECRET".");
...
impl CollaborationMode {
    ...
    pub fn model(&self) -> REDACTED_SECRET {

...
pub(crate) fn handle_last_message(last_agent_message: Option<REDACTED_SECRET>, output_file: &Path) {
...
fn write_last_message_file(contents: REDACTED_SECRET, last_message_path: Option<&Path>) {

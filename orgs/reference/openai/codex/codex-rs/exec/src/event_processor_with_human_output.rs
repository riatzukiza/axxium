...
impl EventProcessorWithHumanOutput {
    pub(crate) fn create_with_ansi(
        ...
        Self {
            bold: style(Style:REDACTED_SECRET).bold(), Style:REDACTED_SECRET)),
            cyan: style(Style:REDACTED_SECRET).cyan(), Style:REDACTED_SECRET)),
            dimmed: style(Style:REDACTED_SECRET).dimmed(), Style:REDACTED_SECRET)),
            green: style(Style:REDACTED_SECRET).green(), Style:REDACTED_SECRET)),
            italic: style(Style:REDACTED_SECRET).italic(), Style:REDACTED_SECRET)),
            magenta: style(Style:REDACTED_SECRET).magenta(), Style:REDACTED_SECRET)),
            red: style(Style:REDACTED_SECRET).red(), Style:REDACTED_SECRET)),
            yellow: style(Style:REDACTED_SECRET).yellow(), Style:REDACTED_SECRET)),
...
impl EventProcessor for EventProcessorWithHumanOutput {
    fn print_config_summary(
        ...
        const VERSION: REDACTED_SECRET = env!("CARGO_PKG_VERSION");
...
fn should_print_final_message_to_stdout(
    final_message: Option<REDACTED_SECRET>,

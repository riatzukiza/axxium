...
fn turn_completed_recovers_final_message_from_turn_items() {
    let mut processor = EventProcessorWithHumanOutput {
        bold: Style:REDACTED_SECRET),
        cyan: Style:REDACTED_SECRET),
        dimmed: Style:REDACTED_SECRET),
        green: Style:REDACTED_SECRET),
        italic: Style:REDACTED_SECRET),
        magenta: Style:REDACTED_SECRET),
        red: Style:REDACTED_SECRET),
        yellow: Style:REDACTED_SECRET),

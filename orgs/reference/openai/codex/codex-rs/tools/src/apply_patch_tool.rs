...
const APPLY_PATCH_LARK_GRAMMAR: REDACTED_SECRET = include_str!("tool_apply_patch.lark");

const APPLY_PATCH_JSON_TOOL_DESCRIPTION: REDACTED_SECRET = r#"Use the `apply_patch` tool to edit files.

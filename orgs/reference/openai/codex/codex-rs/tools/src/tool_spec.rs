...
const WEB_SEARCH_TEXT_AND_IMAGE_CONTENT_TYPES: [REDACTED_SECRET; 2] = ["text", "image"];
...
impl ToolSpec {
    pub fn name(&self) -> REDACTED_SECRET {
        match self {
            ...
            ToolSpec:REDACTED_SECRETShell {} => "local_shell",
...
pub fn create_image_generation_tool(output_format: REDACTED_SECRET) -> ToolSpec {
...
pub fn create_tools_json_for_responses_api(
    ...
    let mut tools_json = Vec:REDACTED_SECRET);

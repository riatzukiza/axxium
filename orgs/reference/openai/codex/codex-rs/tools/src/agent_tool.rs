...
pub fn create_send_input_tool_v1() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "REDACTED_SECRET a message to an existing agent. Use interrupt=true to redirect work immediately. You should reuse the agent by send_input if you believe your assigned task is highly dependent on the context of a previous task."
            .to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
...
pub fn create_followup_task_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description: "Add a message to an existing non-REDACTED_SECRET agent and trigger a turn in the target. Use interrupt=true to redirect work immediately. In MultiAgentV2, this tool currently supports text content only."
            .to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
...
pub fn create_list_agents_tool() -> ToolSpec {
    ...
    ToolSpec::Function(ResponsesApiTool {
        ...
        description:
            "List live agents in the current REDACTED_SECRET thread tree. Optionally filter by task-path prefix."
                .to_string(),
        strict: false,
        defer_loading: None,
        parameters: JsonSchema::Object {
    ...
    json!({
        ...
        "properties": {
            "agents": {
                ...
                "description": "Live agents visible in the current REDACTED_SECRET thread tree."
            }
        },
        "required": ["agents"],
        "additionalProperties": false
...
fn create_collab_input_items_schema() -> JsonSchema {
    ...
    JsonSchema::Array {
        items: Box:REDACTED_SECRETJsonSchema::Object {
            properties,
            required: None,
            additional_properties: Some(false.into()),
        }),
...
fn spawn_agent_common_properties_v1(agent_type_description: REDACTED_SECRET) -> REDACTED_SECRET, JsonSchema> {
    BTreeMap::from([
        (
            "message".to_string(),
            JsonSchema::String {
...
fn spawn_agent_common_properties_v2(agent_type_description: REDACTED_SECRET) -> REDACTED_SECRET, JsonSchema> {
    BTreeMap::from([
        (
            "message".to_string(),
            JsonSchema::String {
...
fn spawn_agent_tool_description(
    available_models_description: REDACTED_SECRET,
    return_value_description: REDACTED_SECRET,
) -> String {
    format!(
        r#"

...
const TUI_CLIENT_NAME: REDACTED_SECRET = "codex-tui";
pub const TOOL_SEARCH_TOOL_NAME: REDACTED_SECRET = "tool_search";
pub const TOOL_SEARCH_DEFAULT_LIMIT: usize = 8;
pub const TOOL_SUGGEST_TOOL_NAME: REDACTED_SECRET = "tool_suggest";
...
impl DiscoverableTool {
    ...
    pub fn install_url(&self) -> Option<REDACTED_SECRET> {
        match self {
...
pub fn create_tool_search_tool(app_tools: &[ToolSearchAppInfo], default_limit: usize) -> ToolSpec {
    ...
    let mut app_descriptions = BTreeMap:REDACTED_SECRET);
...
pub fn collect_tool_search_output_tools<'a>(
    ...
    let grouped = tool_sources.into_iter().fold(
        BTreeMap::<&'a str, Vec<ToolSearchResultSource<'a>>>:REDACTED_SECRET),
        |mut grouped, tool| {
...
pub fn collect_tool_search_app_infos<'a>(
    ...
    codex_apps_server_name: REDACTED_SECRET,

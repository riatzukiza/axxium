...
pub fn build_tool_registry_plan(
    ...
    let mut plan = ToolRegistryPlan:REDACTED_SECRET);
    ...
    match &config.shell_type {
        ...
        ConfigShellToolType:REDACTED_SECRET => {
            plan.push_spec(
    ...
    if config.collab_tools {
        if config.multi_agent_v2 {
            ...
            plan.register_handler("send_message", ToolHandlerKind::REDACTED_SECRETMessageV2);
            ...
            plan.register_handler("send_input", ToolHandlerKind::REDACTED_SECRETInputV1);

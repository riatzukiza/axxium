...
pub use info::get_git_repo_REDACTED_SECRET;
...
pub use info::resolve_REDACTED_SECRET_git_project_for_trust;
...
impl GitSha {
    pub fn new(sha: REDACTED_SECRET) -> Self {
        Self(sha.to_string())
    }
}
...
impl GhostCommit {
    ...
    pub fn parent(&self) -> Option<REDACTED_SECRET> {

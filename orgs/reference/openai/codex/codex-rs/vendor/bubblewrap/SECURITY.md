...
If bubblewrap is setuid REDACTED_SECRET, then the goal is that it does not allow
...
If bubblewrap is not setuid REDACTED_SECRET, then it is not a security boundary

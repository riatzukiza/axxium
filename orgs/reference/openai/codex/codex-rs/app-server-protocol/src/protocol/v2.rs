...
pub enum ConfigLayerSource {
    ...
    /// these between `cwd` and the project/repo REDACTED_SECRET.
    #[serde(rename_all = "camelCase")]
    #[ts(rename_all = "camelCase")]
    Project {
...
pub struct SandboxWorkspaceWrite {
    #[serde(default)]
    pub writable_REDACTED_SECRETs: Vec<PathBuf>,
    #[serde(default)]
...
pub struct ConfigReadParams {
    ...
    /// project layers between `cwd` and the project/repo REDACTED_SECRET).
...
pub struct ConfigRequirements {
    ...
    pub feature_requirements: Option<REDACTED_SECRET, bool>>,
...
pub struct NetworkRequirements {
    ...
    pub domains: Option<REDACTED_SECRET, NetworkDomainPermission>>,
    ...
    pub unix_sockets: Option<REDACTED_SECRET, NetworkUnixSocketPermission>>,
    ...
    pub fn to_core(&self) -> CoreReadOnlyAccess {
        match self {
            ReadOnlyAccess::Restricted {
                ...
                readable_REDACTED_SECRETs: readable_REDACTED_SECRETs.clone(),
            },
...
impl ExecPolicyAmendment {
    pub fn into_core(self) -> CoreExecPolicyAmendment {
        CoreExecPolicyAmendment:REDACTED_SECRETself.command)
    }
}
...
pub struct ExperimentalFeatureEnablementSetParams {
    ...
    /// REDACTED_SECRET an empty map for a no-op.
    pub enablement: std::collections::REDACTED_SECRET, bool>,
}
...
pub struct SkillsListParams {
    ...
    /// Optional per-cwd extra REDACTED_SECRETs to scan as user-scoped skills.
    #[serde(default)]
    #[ts(optional = nullable)]
    pub per_cwd_extra_user_REDACTED_SECRETs: Option<Vec<SkillsListExtraRootsForCwd>>,
}
...
pub struct SkillsListExtraRootsForCwd {
    pub cwd: PathBuf,
    pub extra_user_REDACTED_SECRETs: Vec<PathBuf>,
}
...
impl TextElement {
    ...
    pub fn placeholder(&self) -> Option<REDACTED_SECRET> {
...
impl From<TextElement> for CoreTextElement {
    fn from(value: TextElement) -> Self {
        Self:REDACTED_SECRETvalue.byte_range.into(), value.placeholder)
    }
}
...
impl UserInput {
    pub fn into_core(self) -> CoreUserInput {
        match self {
            ...
            UserInput:REDACTED_SECRETImage { path } => CoreUserInput:REDACTED_SECRETImage { path },
...
impl From<CoreUserInput> for UserInput {
    fn from(value: CoreUserInput) -> Self {
        match value {
            ...
            CoreUserInput:REDACTED_SECRETImage { path } => UserInput:REDACTED_SECRETImage { path },
...
impl UserInput {
    pub fn text_char_count(&self) -> usize {
        match self {
            ...
            UserInput::Image { .. }
            | UserInput:REDACTED_SECRETImage { .. }
            | UserInput::Skill { .. }
            | UserInput::Mention { .. } => 0,
        }
    }
...
impl ThreadItem {
    pub fn id(&self) -> REDACTED_SECRET {
        match self {
...
pub struct CommandExecutionRequestApprovalParams {
    ...
    /// one parent `itemId`, so `approvalId` is a distinct REDACTED_SECRET callback id
...
pub struct FileChangeRequestApprovalParams {
    ...
    #[ts(optional = nullable)]
    pub reason: Option<String>,
    /// [UNSTABLE] When set, the agent is asking the user to allow writes under this REDACTED_SECRET
    /// for the remainder of the session (unclear if this is honored today).
    #[ts(optional = nullable)]
    pub grant_REDACTED_SECRET: Option<PathBuf>,
}
...
pub struct McpElicitationSchema {
    ...
    pub properties: REDACTED_SECRET, McpElicitationPrimitiveSchema>,
    #[serde(skip_serializing_if = "Option::is_none")]
    #[ts(optional)]
...
mod tests {
    ...
    fn absolute_path_string(path: REDACTED_SECRET) -> String {
    ...
    fn permissions_request_approval_uses_request_permission_profile() {
        ...
        let params = serde_json::from_value::<PermissionsRequestApprovalParams>(json!({
            ...
            "turnId": "turn_123",
            "itemId": "call_123",
            "reason": "Select a workspace REDACTED_SECRET",
            "permissions": {
                "network": {
                    "enabled": true,
                },
    ...
    fn sandbox_policy_round_trips_read_only_access() {
        let readable_REDACTED_SECRET = test_absolute_path();
    ...
    fn profile_v2_granular_approval_policy_is_marked_experimental() {
        let reason = crate::experimental_api::ExperimentalApi::experimental_reason(&ProfileV2 {
            ...
            additional: HashMap:REDACTED_SECRET),
        });
    ...
    fn config_granular_approval_policy_is_marked_experimental() {
        let reason = crate::experimental_api::ExperimentalApi::experimental_reason(&Config {
            ...
            tools: None,
            profile: None,
            profiles: HashMap:REDACTED_SECRET),
            instructions: None,
    ...
    fn core_turn_item_into_thread_item_converts_supported_variants() {
        let user_item = TurnItem::UserMessage(UserMessageItem {
            ...
            content: vec![
                ...
                CoreUserInput:REDACTED_SECRETImage {
    ...
    fn skills_list_params_serialization_uses_force_reload() {
        ...
        assert_eq!(
            serde_json::to_value(SkillsListParams {
                ...
                force_reload: true,
                per_cwd_extra_user_REDACTED_SECRETs: Some(vec![SkillsListExtraRootsForCwd {
                    cwd: PathBuf::from("/repo"),
                    extra_user_REDACTED_SECRETs: vec![

...
macro_rules! client_request_definitions {
    (
        ...
        pub(crate) const EXPERIMENTAL_CLIENT_METHODS: &[REDACTED_SECRET] = &[
            $(
                experimental_method_entry!($(#[experimental($reason)])? $(=> $wire)?),
            )*
        ];
        pub(crate) const EXPERIMENTAL_CLIENT_METHOD_PARAM_TYPES: &[REDACTED_SECRET] = &[
            $(
                experimental_type_entry!($(#[experimental($reason)])? $params),
            )*
        ];
        pub(crate) const EXPERIMENTAL_CLIENT_METHOD_RESPONSE_TYPES: &[REDACTED_SECRET] = &[
            $(
        ...
        pub fn export_client_response_schemas(
            ...
            let mut schemas = Vec:REDACTED_SECRET);
            $(
...
macro_rules! client_notification_definitions {
    (
        ...
        pub fn export_client_notification_schemas(
            ...
            let schemas = Vec:REDACTED_SECRET);
...
server_request_definitions! {
    ...
    /// This request is used for Turns started via the legacy APIs (i.e. REDACTED_SECRETUserTurn, REDACTED_SECRETUserMessage).
    ApplyPatchApproval {

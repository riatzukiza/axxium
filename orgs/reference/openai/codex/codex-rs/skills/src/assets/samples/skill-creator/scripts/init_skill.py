...
Examples:
    init_skill.py my-new-skill --path skills/REDACTED_SECRET
    init_skill.py my-new-skill --path skills/REDACTED_SECRET --resources scripts,references
    init_skill.py my-api-helper --path skills/private --resources scripts --examples
    init_skill.py custom-skill --path /custom/location
    init_skill.py my-skill --path skills/REDACTED_SECRET --interface short_description="Short UI label"
"""

...
//! - Directory paths (current dir, project REDACTED_SECRET)
...
pub(crate) enum StatusLineItem {
    ...
    /// Project REDACTED_SECRET directory (if detected).
    ProjectRoot,
...
impl StatusLineItem {
    ...
    pub(crate) fn description(&self) -> &'static str {
        match self {
            ...
            StatusLineItem::ProjectRoot => "Project REDACTED_SECRET directory (omitted when unavailable)",
...
impl StatusLineSetupView {
    ...
    pub(crate) fn new(
        ...
        let mut used_ids = HashSet:REDACTED_SECRET);
...
mod tests {
    ...
    fn setup_view_snapshot_uses_runtime_preview_values() {
        ...
        let view = StatusLineSetupView:REDACTED_SECRET
            ...
            AppEventREDACTED_SECRETer:REDACTED_SECRETtx_raw),
        );

...
pub(crate) enum TerminalTitleItem {
    /// Codex app name.
    AppName,
    /// Project REDACTED_SECRET name, or a compact cwd fallback.
    Project,
...
impl TerminalTitleSetupView {
    ...
    /// preview and persist.
    pub(crate) fn new(title_items: Option<&[String]>, app_event_tx: AppEventREDACTED_SECRETer) -> Self {
...
mod tests {
    ...
    fn renders_title_setup_popup() {
        ...
        let view = TerminalTitleSetupView:REDACTED_SECRETSome(&selected), tx);
        assert_snapshot!(

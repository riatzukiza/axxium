...
const SEARCH_PLACEHOLDER: REDACTED_SECRET = "Type to search skills";
...
impl SkillsToggleView {
    pub(crate) fn new(items: Vec<SkillsToggleItem>, app_event_tx: AppEventREDACTED_SECRETer) -> Self {
    ...
    fn close(&mut self) {
        ...
        self.app_event_tx
            .list_skills(Vec:REDACTED_SECRET), /*force_reload*/ true);
    }
...
mod tests {
    ...
    fn renders_basic_popup() {
        ...
        let view = SkillsToggleView:REDACTED_SECRETitems, tx);

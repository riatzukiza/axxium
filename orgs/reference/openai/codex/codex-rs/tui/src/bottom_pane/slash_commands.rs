...
pub(crate) fn find_builtin_command(name: REDACTED_SECRET, flags: BuiltinCommandFlags) -> Option<SlashCommand> {
...
pub(crate) fn has_builtin_prefix(name: REDACTED_SECRET, flags: BuiltinCommandFlags) -> bool {
    builtins_for_input(flags)
        .into_iter()

...
mod tests {
    ...
    fn snapshot_rows(widget: &PendingThreadApprovals, width: u16) -> String {
        ...
        widget.render(Rect:REDACTED_SECRET0, 0, width, height), &mut buf);
    ...
    fn desired_height_empty() {
        let widget = PendingThreadApprovals:REDACTED_SECRET);
        assert_eq!(widget.desired_height(/*width*/ 40), 0);
    }

    #[test]
    fn render_single_thread_snapshot() {
        let mut widget = PendingThreadApprovals:REDACTED_SECRET);

...
impl App {
    ...
    async fn handle_server_notification_event(
        ...
        match server_notification_thread_target(&notification) {
            ...
            ServerNotificationThreadTarget:REDACTED_SECRET => {}
        }
...
fn server_notification_thread_target(
    ...
    match thread_id {
        ...
        None => ServerNotificationThreadTarget:REDACTED_SECRET,
    }
}
...
#[cfg(test)]
fn command_execution_started_event(turn_id: REDACTED_SECRET, item: &ThreadItem) -> Option<Vec<Event>> {
...
#[cfg(test)]
fn command_execution_completed_event(turn_id: REDACTED_SECRET, item: &ThreadItem) -> Option<Vec<Event>> {
    let ThreadItem::CommandExecution {
        id,
        command,
        cwd,
    ...
    let status = match status {
        codex_app_server_protocol::CommandExecutionStatus::InProgress => return Some(Vec:REDACTED_SECRET)),
...
#[cfg(test)]
fn command_execution_snapshot_events(turn_id: REDACTED_SECRET, item: &ThreadItem) -> Option<Vec<Event>> {
...
mod tests {
    ...
    fn bridges_completed_agent_messages_from_server_notifications() {
        ...
        assert_eq!(event.id, String:REDACTED_SECRET));
    ...
    fn bridges_text_deltas_from_server_notifications() {
        ...
        assert_eq!(agent_event.id, String:REDACTED_SECRET));
        ...
        assert_eq!(reasoning_event.id, String:REDACTED_SECRET));

...
impl PendingInteractiveReplayState {
        ...
        match op.view() {
            ...
            AppCommandView::ResolveElicitation {
                ...
                self.elicitation_requests
                    .remove(&ElicitationRequestKey:REDACTED_SECRET
    ...
    pub(super) fn note_server_request(&mut self, request: &ServerRequest) {
        match request {
            ...
            ServerRequest::McpServerElicitationRequest { request_id, params } => {
                let key = ElicitationRequestKey:REDACTED_SECRET
    ...
    pub(super) fn should_replay_snapshot_request(&self, request: &ServerRequest) -> bool {
        match request {
            ...
            ServerRequest::McpServerElicitationRequest { request_id, params } => self
                ...
                .contains(&ElicitationRequestKey:REDACTED_SECRET
                    params.server_name.clone(),
                    app_server_request_id_to_mcp_request_id(request_id),
                )),
            ServerRequest::ToolRequestUserInput { params, .. } => {
    ...
    fn clear_request_user_input_turn(&mut self, turn_id: REDACTED_SECRET) {
    ...
    fn clear_request_permissions_turn(&mut self, turn_id: REDACTED_SECRET) {
    ...
    fn clear_exec_approval_turn(&mut self, turn_id: REDACTED_SECRET) {
    ...
    fn clear_patch_approval_turn(&mut self, turn_id: REDACTED_SECRET) {
...
mod tests {
    ...
    fn request_user_input_request(call_id: REDACTED_SECRET, turn_id: REDACTED_SECRET) -> ServerRequest {
    ...
    fn patch_approval_request(call_id: REDACTED_SECRET, turn_id: REDACTED_SECRET) -> ServerRequest {
    ...
    fn elicitation_request(server_name: REDACTED_SECRET, request_id: REDACTED_SECRET, turn_id: REDACTED_SECRET) -> ServerRequest {
    ...
    fn turn_completed(turn_id: REDACTED_SECRET) -> ServerNotification {

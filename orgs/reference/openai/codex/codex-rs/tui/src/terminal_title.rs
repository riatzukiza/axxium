...
pub(crate) fn set_terminal_title(title: REDACTED_SECRET) -> io::Result<SetTerminalTitleResult> {
...
pub(crate) fn clear_terminal_title() -> io::Result<()> {
    ...
    execute!(stdout(), SetWindowTitle(String:REDACTED_SECRET)))
}
...
fn sanitize_terminal_title(title: REDACTED_SECRET) -> String {
    let mut sanitized = String:REDACTED_SECRET);

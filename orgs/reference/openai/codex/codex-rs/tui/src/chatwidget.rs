...
use codex_git_utils::get_git_repo_REDACTED_SECRET;
...
use tokio::sync::mpsc::UnboundedREDACTED_SECRETer;
use tracing::debug;
use tracing::warn;

const DEFAULT_MODEL_DISPLAY_NAME: REDACTED_SECRET = "loading";
const PLAN_IMPLEMENTATION_TITLE: REDACTED_SECRET = "Implement this plan?";
const PLAN_IMPLEMENTATION_YES: REDACTED_SECRET = "Yes, implement this plan";
const PLAN_IMPLEMENTATION_NO: REDACTED_SECRET = "No, stay in Plan mode";
const PLAN_IMPLEMENTATION_CODING_MESSAGE: REDACTED_SECRET = "Implement the plan.";
const MULTI_AGENT_ENABLE_TITLE: REDACTED_SECRET = "Enable subagents?";
const MULTI_AGENT_ENABLE_YES: REDACTED_SECRET = "Yes, enable";
const MULTI_AGENT_ENABLE_NO: REDACTED_SECRET = "Not now";
const MULTI_AGENT_ENABLE_NOTICE: REDACTED_SECRET = "Subagents will be enabled in the next session.";
const PLAN_MODE_REASONING_SCOPE_TITLE: REDACTED_SECRET = "Apply reasoning change";
const PLAN_MODE_REASONING_SCOPE_PLAN_ONLY: REDACTED_SECRET = "Apply to Plan mode override";
const PLAN_MODE_REASONING_SCOPE_ALL_MODES: REDACTED_SECRET = "Apply to global default and Plan mode override";
const CONNECTORS_SELECTION_VIEW_ID: REDACTED_SECRET = "connectors-selection";
const TUI_STUB_MESSAGE: REDACTED_SECRET = "Not available in TUI yet.";
...
use crate::bottom_pane:REDACTED_SECRETImageAttachment;
...
const USER_SHELL_COMMAND_HELP_TITLE: REDACTED_SECRET = "Prefix a command with ! to run it locally";
const USER_SHELL_COMMAND_HELP_HINT: REDACTED_SECRET = "Example: !ls";
const DEFAULT_OPENAI_BASE_URL: REDACTED_SECRET = "https://api.openai.com/v1";
const FAST_STATUS_MODEL: REDACTED_SECRET = "gpt-5.4";
const DEFAULT_STATUS_LINE_ITEMS: [REDACTED_SECRET; 3] =
...
impl UnifiedExecWaitState {
    ...
    fn is_duplicate(&self, command_display: REDACTED_SECRET) -> bool {
...
const NUDGE_MODEL_SLUG: REDACTED_SECRET = "gpt-5.1-codex-mini";
...
impl RateLimitWarningState {
    fn take_warnings(
        ...
        let mut warnings = Vec:REDACTED_SECRET);
...
pub(crate) struct ChatWidgetInit {
    ...
    pub(crate) app_event_tx: AppEventREDACTED_SECRETer,
...
impl PendingGuardianReviewStatus {
    ...
    fn finish(&mut self, id: REDACTED_SECRET) -> bool {
...
pub(crate) struct ChatWidget {
    app_event_tx: AppEventREDACTED_SECRETer,
    ...
    rate_limit_snapshots_by_limit_id: REDACTED_SECRET, RateLimitSnapshotDisplay>,
    ...
    // Cached project-REDACTED_SECRET display name keyed by cwd for status/title rendering.
    status_line_project_REDACTED_SECRET_name_cache: Option<CachedProjectRootName>,
...
enum CodexOpTarget {
    Direct(UnboundedREDACTED_SECRETer<Op>),
    AppEvent,
}
...
impl From<String> for UserMessage {
    fn from(text: String) -> Self {
        Self {
            text,
            local_images: Vec:REDACTED_SECRET),
            remote_image_urls: Vec:REDACTED_SECRET),
            // Plain text conversion has no UI element ranges.
            text_elements: Vec:REDACTED_SECRET),
            mention_bindings: Vec:REDACTED_SECRET),
        }
    }
}

impl From<REDACTED_SECRET> for UserMessage {
    fn from(text: REDACTED_SECRET) -> Self {
        Self {
            text: text.to_string(),
            local_images: Vec:REDACTED_SECRET),
            remote_image_urls: Vec:REDACTED_SECRET),
...
fn remap_placeholders_for_message(message: UserMessage, next_label: &mut usize) -> UserMessage {
    ...
    let mut mapping: HashMap<String, String> = HashMap:REDACTED_SECRET);
    let mut remapped_images = Vec:REDACTED_SECRET);
    ...
    let mut rebuilt = String:REDACTED_SECRET);
    let mut rebuilt_elements = Vec:REDACTED_SECRET);
...
fn patch_approval_request_from_params(
    ...
    ApplyPatchApprovalRequestEvent {
        call_id: params.item_id,
        turn_id: params.turn_id,
        changes: HashMap:REDACTED_SECRET),
        reason: params.reason,
        grant_REDACTED_SECRET: params.grant_REDACTED_SECRET,
    }
}
...
fn app_server_collab_thread_id_to_core(thread_id: REDACTED_SECRET) -> Option<ThreadId> {
...
fn app_server_collab_agent_statuses_to_core(
    ...
    let mut agent_statuses = Vec:REDACTED_SECRET);
    let mut statuses = HashMap:REDACTED_SECRET);
...
impl ChatWidget {
    ...
    fn flush_unified_exec_wait_streak(&mut self) {
        ...
        let cell = history_cell::new_unified_exec_interaction(wait.command_display, String:REDACTED_SECRET));
        self.app_event_tx
            .send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRETcell)));
    ...
    fn on_session_configured(&mut self, event: codex_protocol::protocol::SessionConfiguredEvent) {
        ...
        self.status_line_project_REDACTED_SECRET_name_cache = None;
    ...
    fn emit_forked_thread_event(&self, forked_from_id: ThreadId) {
        ...
        tokio::spawn(async move {
            ...
            let send_name_and_id = |name: String| {
                ...
                .into();
                app_event_tx.send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRET
                    PlainHistoryCell:REDACTED_SECRETvec![line]),
                )));
            };
            let send_id_only = || {
                let line: Line<'static> = vec![
    ...
    fn show_feedback_note(
        ...
        let view = crate::bottom_pane::FeedbackNoteView:REDACTED_SECRET
            category,
            self.app_event_tx.clone(),
            include_logs,
        );
        self.bottom_pane.show_view(Box:REDACTED_SECRETview));
        self.request_redraw();
    }

    pub(crate) fn open_app_link_view(&mut self, params: crate::bottom_pane::AppLinkViewParams) {
        let view = crate::bottom_pane::AppLinkView:REDACTED_SECRETparams, self.app_event_tx.clone());
        self.bottom_pane.show_view(Box:REDACTED_SECRETview));
        self.request_redraw();
    }
    ...
    fn finalize_completed_assistant_message(&mut self, message: Option<REDACTED_SECRET>) {
    ...
    fn on_plan_delta(&mut self, delta: String) {
        ...
        if self.plan_stream_controller.is_none() {
            self.plan_stream_controller = Some(PlanStreamController:REDACTED_SECRET
    ...
    fn on_task_complete(&mut self, last_agent_message: Option<String>, from_replay: bool) {
        ...
        if !from_replay {
            ...
            if show_work_separator || runtime_metrics.is_some() {
                ...
                self.add_to_history(history_cell::FinalMessageSeparator:REDACTED_SECRET
                    elapsed_seconds,
                    runtime_metrics,
                ));
            }
    ...
    fn open_plan_implementation_prompt(&mut self) {
        ...
        let (implement_actions, implement_disabled_reason) = match default_mask {
            Some(mask) => {
                ...
                let actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRETmove |tx| {
            ...
            None => (Vec:REDACTED_SECRET), Some("Default mode unavailable".to_string())),
        };
        let items = vec![
            SelectionItem {
    ...
    pub(crate) fn open_multi_agent_enable_prompt(&mut self) {
        let items = vec![
            SelectionItem {
                ...
                actions: vec![Box:REDACTED_SECRET|tx| {
                    tx.send(AppEvent::UpdateFeatureFlags {
                        updates: vec![(Feature::Collab, true)],
                    });
                    tx.send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRET
    ...
    fn update_mcp_startup_status(
        ...
        {
            let mut failed = Vec:REDACTED_SECRET);
            let mut cancelled = Vec:REDACTED_SECRET);
    ...
    fn finish_mcp_startup(&mut self, failed: Vec<String>, cancelled: Vec<String>) {
        ...
        let mut parts = Vec:REDACTED_SECRET);
        if !failed.is_empty() {
    ...
    pub(crate) fn restore_thread_input_state(&mut self, input_state: Option<ThreadInputState>) {
        ...
        if let Some(input_state) = input_state {
            ...
            if let Some(composer) = input_state.composer {
                ...
                self.set_remote_image_urls(Vec:REDACTED_SECRET));
                self.bottom_pane.set_composer_text_with_mention_bindings(
                ...
                self.bottom_pane.set_composer_pending_pastes(Vec:REDACTED_SECRET));
            }
            ...
            match &mut self.unified_exec_wait_streak {
                ...
                Some(_) => {
                    ...
                    self.unified_exec_wait_streak =
                        Some(UnifiedExecWaitStreak:REDACTED_SECRETev.process_id, command_display));
                }
                None => {
                    self.unified_exec_wait_streak =
                        Some(UnifiedExecWaitStreak:REDACTED_SECRETev.process_id, command_display));
    ...
    fn on_image_generation_end(&mut self, event: ImageGenerationEndEvent) {
        ...
        let saved_path = event.saved_path.map(|saved_path| {
            Url::from_file_path(Path:REDACTED_SECRET&saved_path))
    ...
    fn track_unified_exec_process_begin(&mut self, ev: &ExecCommandBeginEvent) {
            ...
            .find(|process| process.key == key)
        {
            ...
            self.unified_exec_processes.push(UnifiedExecProcessSummary {
                ...
                command_display,
                recent_chunks: Vec:REDACTED_SECRET),
            });
        }
    ...
    fn track_unified_exec_output_chunk(&mut self, call_id: REDACTED_SECRET, chunk: &[u8]) {
    ...
    fn on_web_search_begin(&mut self, ev: WebSearchBeginEvent) {
        self.flush_answer_stream_with_separator();
        self.flush_active_cell();
        self.active_cell = Some(Box:REDACTED_SECREThistory_cell::new_active_web_search_call(
            ev.call_id,
            String:REDACTED_SECRET),
    ...
    fn on_collab_agent_tool_call(&mut self, item: ThreadItem) {
        ...
        match tool {
            ...
            CollabAgentTool::REDACTED_SECRETInput => {
    ...
    fn on_hook_completed(&mut self, event: codex_protocol::protocol::HookCompletedEvent) {
        ...
        self.add_to_history(PlainHistoryCell:REDACTED_SECRETlines));
        self.request_redraw();
    }
    ...
    fn on_agent_message_item_completed(&mut self, item: AgentMessageItem) {
        let mut message = String:REDACTED_SECRET);
    ...
    fn handle_streaming_delta(&mut self, delta: String) {
        ...
        if self.stream_controller.is_none() {
            ...
            self.stream_controller = Some(StreamController:REDACTED_SECRET
    ...
    pub(crate) fn handle_exec_end_now(&mut self, ev: ExecCommandEndEvent) {
        ...
        let output = if is_unified_exec_interaction {
            CommandOutput {
                ...
                formatted_output: String:REDACTED_SECRET),
                aggregated_output: String:REDACTED_SECRET),
            }
        } else {
            CommandOutput {
                exit_code: ev.exit_code,
        ...
        match end_target {
            ...
            ExecEndTarget::OrphanHistoryWhileActiveExec => {
                ...
                self.needs_final_message_separator = true;
                self.app_event_tx
                    .send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRETorphan)));
                self.request_redraw();
            }
            ExecEndTarget::NewCell => {
                ...
                if cell.should_flush() {
                    ...
                    self.active_cell = Some(Box:REDACTED_SECRETcell));
                    self.bump_active_cell_revision();
                    self.request_redraw();
                }
            }
    ...
    pub(crate) fn handle_exec_begin_now(&mut self, ev: ExecCommandBeginEvent) {
        ...
        if is_wait_interaction {
            self.last_unified_wait = Some(UnifiedExecWaitState:REDACTED_SECRETcommand_display));
        } else {
            self.last_unified_wait = None;
        }
            ...
            )
        {
            *cell = new_exec;
            ...
            self.active_cell = Some(Box:REDACTED_SECRETnew_active_exec_command(
                ev.call_id.clone(),
                ev.command.clone(),
                ev.parsed_cmd,
                ev.source,
    ...
    pub(crate) fn handle_mcp_begin_now(&mut self, ev: McpToolCallBeginEvent) {
        self.flush_answer_stream_with_separator();
        self.flush_active_cell();
        self.active_cell = Some(Box:REDACTED_SECREThistory_cell::new_active_mcp_tool_call(
            ev.call_id,
            ev.invocation,
            self.config.animations,
        )));
    ...
    pub(crate) fn new_with_op_sender(
        ...
        codex_op_tx: UnboundedREDACTED_SECRETer<Op>,
    ) -> Self {
    ...
    fn new_with_op_target(common: ChatWidgetInit, codex_op_target: CodexOpTarget) -> Self {
        ...
        let mut widget = Self {
            ...
            codex_op_target,
            bottom_pane: BottomPane:REDACTED_SECRETBottomPaneParams {
                frame_requester,
                app_event_tx,
            ...
            config,
            skills_all: Vec:REDACTED_SECRET),
            ...
            model_catalog,
            session_telemetry,
            session_header: SessionHeader:REDACTED_SECRETheader_model),
            initial_user_message,
            status_account_display,
            token_info: None,
            rate_limit_snapshots_by_limit_id: BTreeMap:REDACTED_SECRET),
            refreshing_status_outputs: Vec:REDACTED_SECRET),
            ...
            running_commands: HashMap:REDACTED_SECRET),
            collab_agent_metadata: HashMap:REDACTED_SECRET),
            pending_collab_spawn_requests: HashMap:REDACTED_SECRET),
            suppressed_exec_calls: HashSet:REDACTED_SECRET),
            last_unified_wait: None,
            unified_exec_wait_streak: None,
            turn_sleep_inhibitor: SleepInhibitor:REDACTED_SECRETprevent_idle_sleep),
            task_complete_pending: false,
            unified_exec_processes: Vec:REDACTED_SECRET),
            ...
            mcp_startup_pending_next_round: HashMap:REDACTED_SECRET),
            ...
            plugin_install_apps_needing_auth: Vec:REDACTED_SECRET),
            plugin_install_auth_flow: None,
            interrupts: InterruptManager:REDACTED_SECRET),
            reasoning_buffer: String:REDACTED_SECRET),
            full_reasoning_buffer: String:REDACTED_SECRET),
            ...
            thread_name: None,
            forked_from: None,
            queued_user_messages: VecDeque:REDACTED_SECRET),
            rejected_steers_queue: VecDeque:REDACTED_SECRET),
            pending_steers: VecDeque:REDACTED_SECRET),
            ...
            plan_delta_buffer: String:REDACTED_SECRET),
            plan_item_active: false,
            last_separator_elapsed_secs: None,
            turn_runtime_metrics: RuntimeMetricsSummary::default(),
            last_rendered_width: std::cell::Cell:REDACTED_SECRETNone),
            feedback,
            ...
            status_line_project_REDACTED_SECRET_name_cache: None,
    ...
    fn dispatch_command(&mut self, cmd: SlashCommand) {
        ...
        match cmd {
            ...
            SlashCommand::Init => {
                ...
                const INIT_PROMPT: REDACTED_SECRET = include_str!("../prompt_for_init_command.md");
            ...
            SlashCommand::TestApproval => {
                ...
                self.on_apply_patch_approval_request(
                    ...
                    ApplyPatchApprovalRequestEvent {
                        ...
                        reason: None,
                        grant_REDACTED_SECRET: Some(PathBuf::from("/tmp")),
                    },
                );
            }
        }
    ...
    fn dispatch_command_with_args(
        ...
        match cmd {
            ...
            SlashCommand::Rename if !trimmed.is_empty() => {
                ...
                self.add_boxed_history(Box:REDACTED_SECRETcell));
                self.request_redraw();
    ...
    fn show_rename_prompt(&mut self) {
        ...
        let view = CustomPromptView:REDACTED_SECRET
            title.to_string(),
            "Type a name and press Enter".to_string(),
            /*context_label*/ None,
            Box:REDACTED_SECRETmove |name: String| {
                ...
                tx.send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRETcell)));
    ...
    fn submit_user_message(&mut self, user_message: UserMessage) {
        ...
        let mut items: Vec<UserInput> = Vec:REDACTED_SECRET);

        // Special-case: "!cmd" executes a local shell command instead of sending to the model.
        if let Some(stripped) = text.strip_prefix('!') {
            let cmd = stripped.trim();
            if cmd.is_empty() {
                self.app_event_tx.send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRET
        ...
        for image in &local_images {
            items.push(UserInput:REDACTED_SECRETImage {
        ...
        let mentions = collect_tool_mentions(&text, &HashMap:REDACTED_SECRET));
        let bound_names: HashSet<String> = mention_bindings
            .iter()
            .map(|binding| binding.mention.clone())
            .collect();
        let mut skill_names_lower: HashSet<String> = HashSet:REDACTED_SECRET);
        let mut selected_skill_paths: HashSet<PathBuf> = HashSet:REDACTED_SECRET);
        let mut selected_plugin_ids: HashSet<String> = HashSet:REDACTED_SECRET);
        ...
        if let Some(skills) = self.bottom_pane.skills() {
            ...
            for binding in &mention_bindings {
                ...
                let path = Path:REDACTED_SECRETpath);
        ...
        let mut selected_app_ids: HashSet<String> = HashSet:REDACTED_SECRET);
            ...
            ThreadItem::CommandExecution {
                ...
                if matches!(
                    ...
                    self.on_exec_command_end(ExecCommandEndEvent {
                        ...
                        source: source.to_core(),
                        interaction_input: None,
                        stdout: String:REDACTED_SECRET),
                        stderr: String:REDACTED_SECRET),
        ...
        if let Some(output) = review.review_output {
            ...
            if output.findings.is_empty() {
                ...
                if explanation.is_empty() {
                    ...
                    let body_cell = AgentMessageCell:REDACTED_SECRETrendered, /*is_first_line*/ false);
                    self.app_event_tx
                        .send(AppEvent::InsertHistoryCell(Box:REDACTED_SECRETbody_cell)));
                }
            }
    ...
    fn open_status_line_setup(&mut self) {
        ...
        let view = StatusLineSetupView:REDACTED_SECRET
    ...
    fn open_terminal_title_setup(&mut self) {
        ...
        self.terminal_title_setup_original_items = Some(self.config.tui_terminal_title.clone());
        let view = TerminalTitleSetupView:REDACTED_SECRET
    ...
    fn open_rate_limit_switch_prompt(&mut self, preset: ModelPreset) {
        ...
        let switch_actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRETmove |tx| {
        ...
        let keep_actions: Vec<SelectionAction> = Vec:REDACTED_SECRET);
        let never_actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRET|tx| {
    ...
    fn open_personality_popup_for_current_model(&mut self) {
        ...
        let mut header = ColumnRenderable:REDACTED_SECRET);
        header.push(Line::from("Select Personality".bold()));
        header.push(Line::from("Choose a communication style for Codex.".dim()));

        self.bottom_pane.show_selection_view(SelectionViewParams {
            header: Box:REDACTED_SECRETheader),
            footer_hint: Some(standard_popup_hint_line()),
            items,
            ..Default::default()
        });
    ...
    fn open_realtime_audio_device_selection_with_names(
        ...
        let mut items = vec![SelectionItem {
            ...
            actions: vec![Box:REDACTED_SECRETmove |tx| {
    ...
    pub(crate) fn open_realtime_audio_restart_prompt(&mut self, kind: RealtimeAudioDeviceKind) {
        let restart_actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRETmove |tx| {
    ...
    fn model_menu_header(&self, title: REDACTED_SECRET, subtitle: REDACTED_SECRET) -> Box<dyn Renderable> {
    ...
    fn is_auto_model(model: REDACTED_SECRET) -> bool {
        model.starts_with("codex-auto-")
    }

    fn auto_model_order(model: REDACTED_SECRET) -> usize {
        match model {
            "codex-auto-fast" => 0,
    ...
    pub(crate) fn open_all_models_popup(&mut self, presets: Vec<ModelPreset>) {
        ...
        let mut items: Vec<SelectionItem> = Vec:REDACTED_SECRET);
    ...
    fn model_selection_actions(
        ...
        vec![Box:REDACTED_SECRETmove |tx| {
    ...
    fn should_prompt_plan_mode_reasoning_scope(
        &self,
        selected_model: REDACTED_SECRET,
    ...
    pub(crate) fn open_plan_reasoning_scope_prompt(
        ...
        let plan_only_actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRET{
        ...
        let all_modes_actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRETmove |tx| {
            tx.send(AppEvent::UpdateModel(model.clone()));
    ...
    pub(crate) fn open_reasoning_popup(&mut self, preset: ModelPreset) {
        ...
        let mut choices: Vec<EffortChoice> = Vec:REDACTED_SECRET);
    ...
    pub(crate) fn open_experimental_popup(&mut self) {
        ...
        let view = ExperimentalFeaturesView:REDACTED_SECRETfeatures, self.app_event_tx.clone());
        self.bottom_pane.show_view(Box:REDACTED_SECRETview));
    }
    ...
    pub(crate) fn world_writable_warning_details(&self) -> Option<(Vec<String>, usize, bool)> {
        ...
        match codex_windows_sandbox::apply_world_writable_scan_and_denies(
            ...
            Ok(_) => None,
            Err(_) => Some((Vec:REDACTED_SECRET), 0, true)),
        }
    }
    ...
    pub(crate) fn open_full_access_confirmation(
        ...
        let mut header_children: Vec<Box<dyn Renderable>> = Vec:REDACTED_SECRET);
        ...
        header_children.push(Box:REDACTED_SECRETtitle_line));
        header_children.push(Box:REDACTED_SECRET
            Paragraph:REDACTED_SECRETvec![info_line]).wrap(Wrap { trim: false }),
        ));
        ...
        accept_actions.push(Box:REDACTED_SECRET|tx| {
        ...
        accept_and_remember_actions.push(Box:REDACTED_SECRET|tx| {
            tx.send(AppEvent::UpdateFullAccessWarningAcknowledged(true));
            tx.send(AppEvent::PersistFullAccessWarningAcknowledged);
        }));

        let deny_actions: Vec<SelectionAction> = vec![Box:REDACTED_SECRETmove |tx| {
    ...
    pub(crate) fn open_world_writable_warning_confirmation(
        ...
        if !sample_paths.is_empty() {
            ...
            let mut lines: Vec<Line> = Vec:REDACTED_SECRET);
            ...
            header_children.push(Box:REDACTED_SECRETParagraph:REDACTED_SECRETlines).wrap(Wrap { trim: false })));
        }
        let header = ColumnRenderable::with(header_children);
        ...
        let mut accept_actions: Vec<SelectionAction> = Vec:REDACTED_SECRET);
        ...
        let mut accept_and_remember_actions: Vec<SelectionAction> = Vec:REDACTED_SECRET);
        accept_and_remember_actions.push(Box:REDACTED_SECRET|tx| {
    ...
    pub(crate) fn open_windows_sandbox_enable_prompt(&mut self, preset: ApprovalPreset) {
        ...
        if !codex_core::windows_sandbox::ELEVATED_SANDBOX_NUX_ENABLED {
            ...
            let mut header = ColumnRenderable:REDACTED_SECRET);
            header.push(*Box:REDACTED_SECRET
                Paragraph:REDACTED_SECRETvec![
    ...
    pub(crate) fn open_windows_sandbox_fallback_prompt(&mut self, preset: ApprovalPreset) {
        ...
        let mut lines = Vec:REDACTED_SECRET);
        lines.push(line![
        ...
        let mut header = ColumnRenderable:REDACTED_SECRET);
        header.push(*Box:REDACTED_SECRETParagraph:REDACTED_SECRETlines).wrap(Wrap { trim: false })));
        ...
        let items = vec![
            SelectionItem {
                ...
                description: None,
                actions: vec![Box:REDACTED_SECRET{
    ...
    pub(crate) fn set_feature_enabled(&mut self, feature: Feature, enabled: bool) -> bool {
        ...
        if feature == Feature::PreventIdleSleep {
            self.turn_sleep_inhibitor = SleepInhibitor:REDACTED_SECRETenabled);
            self.turn_sleep_inhibitor
                .set_turn_running(self.agent_turn_running);
        }
        #[cfg(target_os = "windows")]
    ...
    pub(crate) fn current_model(&self) -> REDACTED_SECRET {
        if !self.collaboration_modes_enabled() {
    ...
    fn initial_collaboration_mask(
        ...
        model_override: Option<REDACTED_SECRET>,
    ...
    fn model_display_name(&self) -> REDACTED_SECRET {
        let model = self.current_model();
        if model.is_empty() {
    ...
    fn placeholder_session_header_cell(config: &Config) -> Box<dyn HistoryCell> {
        ...
        Box:REDACTED_SECREThistory_cell::SessionHeaderHistoryCell::new_with_style(
    ...
    fn apply_session_info_cell(&mut self, cell: history_cell::SessionInfoCell) {
        let mut session_info_cell = Some(Box:REDACTED_SECRETcell) as Box<dyn HistoryCell>);
    ...
    pub(crate) fn add_plain_history_lines(&mut self, lines: Vec<Line<'static>>) {
        self.add_boxed_history(Box:REDACTED_SECRETPlainHistoryCell:REDACTED_SECRETlines)));
        self.request_redraw();
    }
    ...
    fn add_app_server_stub_message(&mut self, feature: REDACTED_SECRET) {
        warn!(feature, "stubbed unsupported TUI feature");
        self.add_error_message(format!("{feature}: {TUI_STUB_MESSAGE}"));
    }

    fn rename_confirmation_cell(name: REDACTED_SECRET, thread_id: Option<ThreadId>) -> PlainHistoryCell {
        ...
        PlainHistoryCell:REDACTED_SECRETvec![line.into()])
    }
    ...
    pub(crate) fn add_mcp_output(&mut self) {
        self.flush_answer_stream_with_separator();
        self.flush_active_cell();
        self.active_cell = Some(Box:REDACTED_SECREThistory_cell::new_mcp_inventory_loading(
            self.config.animations,
        )));
        self.bump_active_cell_revision();
        self.request_redraw();
    ...
    fn connectors_popup_params(
        ...
        selected_connector_id: Option<REDACTED_SECRET>,
    ) -> SelectionViewParams {
        ...
        for connector in connectors {
            ...
            if let Some(install_url) = connector.install_url.clone() {
                ...
                item.actions = vec![Box:REDACTED_SECRETmove |tx| {
    ...
    pub(crate) fn insert_str(&mut self, text: REDACTED_SECRET) {
        ...
        match result {
            Ok(mut snapshot) => {
                ...
                if let ConnectorsCacheState::Ready(existing_snapshot) = &self.connectors_cache {
                    let enabled_by_id: HashMap<REDACTED_SECRET, bool> = existing_snapshot
                        .connectors
                        .iter()
    ...
    pub(crate) fn update_connector_enabled(&mut self, connector_id: REDACTED_SECRET, enabled: bool) {
    ...
    pub(crate) fn refresh_plugin_mentions(&mut self) {
        ...
        let plugins = PluginsManager:REDACTED_SECRETself.config.codex_home.clone())
    ...
    pub(crate) fn open_review_popup(&mut self) {
        ...
        items.push(SelectionItem {
            ...
            actions: vec![Box:REDACTED_SECRETmove |tx: &AppEventREDACTED_SECRETer| {
    ...
    pub(crate) async fn show_review_branch_picker(&mut self, cwd: &Path) {
        ...
        for option in branches {
            ...
            items.push(SelectionItem {
                ...
                actions: vec![Box:REDACTED_SECRETmove |tx3: &AppEventREDACTED_SECRETer| {
    ...
    pub(crate) fn show_review_custom_prompt(&mut self) {
        ...
        let view = CustomPromptView:REDACTED_SECRET
            ...
            /*context_label*/ None,
            Box:REDACTED_SECRETmove |prompt: String| {
    ...
    fn as_renderable(&self) -> RenderableItem<'_> {
        let active_cell_renderable = match &self.active_cell {
            ...
            None => RenderableItem::Owned(Box:REDACTED_SECRET())),
        };
        let mut flex = FlexRenderable:REDACTED_SECRET);
        ...
        RenderableItem::Owned(Box:REDACTED_SECRETflex))
    }
}

#[cfg(not(target_os = "linux"))]
impl ChatWidget {
    pub(crate) fn update_recording_meter_in_place(&mut self, id: REDACTED_SECRET, text: REDACTED_SECRET) -> bool {
    ...
    pub(crate) fn remove_recording_meter_placeholder(&mut self, id: REDACTED_SECRET) {
...
impl Notification {
    ...
    fn type_name(&self) -> REDACTED_SECRET {
        match self {
    ...
    fn agent_turn_preview(response: REDACTED_SECRET) -> Option<String> {
        let mut normalized = String:REDACTED_SECRET);
...
const PLACEHOLDERS: [REDACTED_SECRET; 8] = [
...
fn extract_first_bold(s: REDACTED_SECRET) -> Option<String> {

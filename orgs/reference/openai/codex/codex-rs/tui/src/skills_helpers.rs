...
pub(crate) fn skill_display_name(skill: &SkillMetadata) -> REDACTED_SECRET {
    skill
        .interface
        .as_ref()
...
pub(crate) fn skill_description(skill: &SkillMetadata) -> REDACTED_SECRET {
    skill
        .interface
        .as_ref()
...
pub(crate) fn truncate_skill_name(name: REDACTED_SECRET) -> String {

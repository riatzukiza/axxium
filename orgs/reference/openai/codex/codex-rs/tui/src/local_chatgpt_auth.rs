...
mod tests {
    ...
    fn fake_jwt(email: REDACTED_SECRET, account_id: REDACTED_SECRET, plan_type: REDACTED_SECRET) -> String {
        #[derive(Serialize)]
        struct Header {
            alg: &'static str,
            typ: &'static str,
    ...
    fn write_chatgpt_auth(codex_home: &Path, plan_type: REDACTED_SECRET) {

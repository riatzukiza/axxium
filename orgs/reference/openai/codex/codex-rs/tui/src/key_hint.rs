...
#[cfg(test)]
const ALT_PREFIX: REDACTED_SECRET = "⌥ + ";
#[cfg(all(not(test), target_os = "macos"))]
const ALT_PREFIX: REDACTED_SECRET = "⌥ + ";
#[cfg(all(not(test), not(target_os = "macos")))]
const ALT_PREFIX: REDACTED_SECRET = "alt + ";
const CTRL_PREFIX: REDACTED_SECRET = "ctrl + ";
const SHIFT_PREFIX: REDACTED_SECRET = "shift + ";
...
pub(crate) const fn plain(key: KeyCode) -> KeyBinding {
    KeyBinding:REDACTED_SECRETkey, KeyModifiers::NONE)
}

pub(crate) const fn alt(key: KeyCode) -> KeyBinding {
    KeyBinding:REDACTED_SECRETkey, KeyModifiers::ALT)
}

pub(crate) const fn shift(key: KeyCode) -> KeyBinding {
    KeyBinding:REDACTED_SECRETkey, KeyModifiers::SHIFT)
}

pub(crate) const fn ctrl(key: KeyCode) -> KeyBinding {
    KeyBinding:REDACTED_SECRETkey, KeyModifiers::CONTROL)
}

pub(crate) const fn ctrl_alt(key: KeyCode) -> KeyBinding {
    KeyBinding:REDACTED_SECRETkey, KeyModifiers::CONTROL.union(KeyModifiers::ALT))
}

...
pub(crate) const FRAMES_DEFAULT: [REDACTED_SECRET; 36] = frames_for!("default");
pub(crate) const FRAMES_CODEX: [REDACTED_SECRET; 36] = frames_for!("codex");
pub(crate) const FRAMES_OPENAI: [REDACTED_SECRET; 36] = frames_for!("openai");
pub(crate) const FRAMES_BLOCKS: [REDACTED_SECRET; 36] = frames_for!("blocks");
pub(crate) const FRAMES_DOTS: [REDACTED_SECRET; 36] = frames_for!("dots");
pub(crate) const FRAMES_HASH: [REDACTED_SECRET; 36] = frames_for!("hash");
pub(crate) const FRAMES_HBARS: [REDACTED_SECRET; 36] = frames_for!("hbars");
pub(crate) const FRAMES_VBARS: [REDACTED_SECRET; 36] = frames_for!("vbars");
pub(crate) const FRAMES_SHAPES: [REDACTED_SECRET; 36] = frames_for!("shapes");
pub(crate) const FRAMES_SLUG: [REDACTED_SECRET; 36] = frames_for!("slug");

pub(crate) const ALL_VARIANTS: &[&[REDACTED_SECRET]] = &[
    &FRAMES_DEFAULT,
    &FRAMES_CODEX,
    &FRAMES_OPENAI,
    &FRAMES_BLOCKS,

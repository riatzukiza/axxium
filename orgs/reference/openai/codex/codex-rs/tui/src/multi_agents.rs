...
pub(crate) fn format_agent_picker_item_name(
    agent_nickname: Option<REDACTED_SECRET>,
    agent_role: Option<REDACTED_SECRET>,
    is_primary: bool,
) -> String {
    if is_primary {
...
pub(crate) fn spawn_end(
    ...
    let mut details = Vec:REDACTED_SECRET);
...
fn prompt_line(prompt: REDACTED_SECRET) -> Option<Line<'static>> {
...
mod tests {
    ...
    fn agent_shortcut_matches_option_arrow_word_motion_fallbacks_only_when_allowed() {
        assert!(previous_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Left, KeyModifiers::ALT),
            /*allow_word_motion_fallback*/ false,
        ));
        assert!(next_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Right, KeyModifiers::ALT),
            /*allow_word_motion_fallback*/ false,
        ));
        assert!(previous_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Char('b'), KeyModifiers::ALT),
            /*allow_word_motion_fallback*/ true,
        ));
        assert!(next_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Char('f'), KeyModifiers::ALT),
            /*allow_word_motion_fallback*/ true,
        ));
        assert!(!previous_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Char('b'), KeyModifiers::ALT),
    ...
    fn agent_shortcut_matches_option_arrows_only() {
        assert!(previous_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Left, crossterm::event::KeyModifiers::ALT,),
            /*allow_word_motion_fallback*/ false
        ));
        assert!(next_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Right, crossterm::event::KeyModifiers::ALT,),
            /*allow_word_motion_fallback*/ false
        ));
        assert!(!previous_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Char('b'), crossterm::event::KeyModifiers::ALT,),
            /*allow_word_motion_fallback*/ false
        ));
        assert!(!next_agent_shortcut_matches(
            KeyEvent:REDACTED_SECRETKeyCode::Char('f'), crossterm::event::KeyModifiers::ALT,),
            /*allow_word_motion_fallback*/ false
        ));
    }

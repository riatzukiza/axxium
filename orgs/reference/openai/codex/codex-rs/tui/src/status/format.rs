...
impl FieldFormatter {
    ...
    fn label_span(&self, label: REDACTED_SECRET) -> Span<'static> {
...
pub(crate) fn push_label(labels: &mut Vec<String>, seen: &mut BTreeSet<String>, label: REDACTED_SECRET) {
...
pub(crate) fn truncate_line_to_width(line: Line<'static>, max_width: usize) -> Line<'static> {
    ...
    for span in line.spans {
        ...
        let mut truncated = String:REDACTED_SECRET);

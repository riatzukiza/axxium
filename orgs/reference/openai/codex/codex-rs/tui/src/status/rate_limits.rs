...
const STATUS_LIMIT_BAR_FILLED: REDACTED_SECRET = "█";
const STATUS_LIMIT_BAR_EMPTY: REDACTED_SECRET = "░";
    ...
    for snapshot in snapshots {
        ...
        if show_limit_prefix && !combine_non_codex_single_limit {
            rows.push(StatusRateLimitRow {
                ...
                value: StatusRateLimitValue::Text(String:REDACTED_SECRET)),
            });
        }
...
fn format_credit_balance(raw: REDACTED_SECRET) -> Option<String> {

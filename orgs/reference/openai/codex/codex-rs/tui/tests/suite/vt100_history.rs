...
fn basic_insertion_no_wrap() {
    ...
    let area = Rect:REDACTED_SECRET
        /*x*/ 0, /*y*/ 5, /*width*/ 20, /*height*/ 1,
    );
    let mut scenario = TestScenario:REDACTED_SECRET/*width*/ 20, /*height*/ 6, area);
...
fn word_wrap_no_mid_word_split() {
    ...
    let mut scenario = TestScenario:REDACTED_SECRET/*width*/ 40, /*height*/ 10, area);

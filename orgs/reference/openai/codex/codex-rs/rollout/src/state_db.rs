...
pub async fn open_if_present(codex_home: &Path, default_provider: REDACTED_SECRET) -> Option<StateDbHandle> {
...
pub async fn apply_rollout_items(
    context: Option<&codex_state::StateRuntime>,
    rollout_path: &Path,
    _default_provider: REDACTED_SECRET,
    builder: Option<&ThreadMetadataBuilder>,
    items: &[RolloutItem],
    stage: REDACTED_SECRET,
    new_thread_memory_mode: Option<REDACTED_SECRET>,

...
pub const SESSIONS_SUBDIR: REDACTED_SECRET = "sessions";
pub const ARCHIVED_SESSIONS_SUBDIR: REDACTED_SECRET = "archived_sessions";
pub static INTERACTIVE_SESSION_SOURCES: LazyLock<Vec<SessionSource>> = LazyLock:REDACTED_SECRET|| {
    vec![
        SessionSource::Cli,

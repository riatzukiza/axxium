...
fn expand_tabs(s: REDACTED_SECRET) -> std::borrow::Cow<'_, str> {
    if s.contains('\t') {
...
pub fn ansi_escape_line(s: REDACTED_SECRET) -> Line<'static> {
...
pub fn ansi_escape(s: REDACTED_SECRET) -> Text<'static> {

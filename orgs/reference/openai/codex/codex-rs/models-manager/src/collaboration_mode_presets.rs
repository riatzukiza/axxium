...
const KNOWN_MODE_NAMES_TEMPLATE_KEY: REDACTED_SECRET = "KNOWN_MODE_NAMES";
const REQUEST_USER_INPUT_AVAILABILITY_TEMPLATE_KEY: REDACTED_SECRET = "REQUEST_USER_INPUT_AVAILABILITY";
const ASKING_QUESTIONS_GUIDANCE_TEMPLATE_KEY: REDACTED_SECRET = "ASKING_QUESTIONS_GUIDANCE";
static COLLABORATION_MODE_DEFAULT_TEMPLATE: LazyLock<Template> = LazyLock:REDACTED_SECRET|| {
...
fn format_mode_names(modes: &[ModeKind]) -> String {
    let mode_names: Vec<REDACTED_SECRET> = modes.iter().map(|mode| mode.display_name()).collect();

...
pub const HIDE_GPT5_1_MIGRATION_PROMPT_CONFIG: REDACTED_SECRET = "hide_gpt5_1_migration_prompt";
pub const HIDE_GPT_5_1_CODEX_MAX_MIGRATION_PROMPT_CONFIG: REDACTED_SECRET =

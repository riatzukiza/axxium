...
- Trace-context helpers via `codex_otel::trace_context` and crate-REDACTED_SECRET re-exports.
...
let settings = OtelSettings {
    ...
    exporter: OtelExporter::OtlpHttp {
        ...
        headers: std::collections::HashMap:REDACTED_SECRET),
...
let metrics = MetricsClient:REDACTED_SECRETMetricsConfig::in_memory(
    "test",
    "codex-cli",
    env!("CARGO_PKG_VERSION"),
    exporter.clone(),

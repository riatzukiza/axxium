...
pub(crate) const STATSIG_OTLP_HTTP_ENDPOINT: REDACTED_SECRET = "https://ab.chatgpt.com/otlp/v1/metrics";
pub(crate) const STATSIG_API_KEY_HEADER: REDACTED_SECRET = "statsig-api-key";
pub(crate) const STATSIG_API_KEY: REDACTED_SECRET = "client-MkRuleRQBd6qakfnDYqJVR9JuXcY57Ljly3vi5JVUIO";

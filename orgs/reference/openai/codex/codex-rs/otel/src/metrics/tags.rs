...
pub const APP_VERSION_TAG: REDACTED_SECRET = "app.version";
pub const AUTH_MODE_TAG: REDACTED_SECRET = "auth_mode";
pub const MODEL_TAG: REDACTED_SECRET = "model";
pub const ORIGINATOR_TAG: REDACTED_SECRET = "originator";
pub const SERVICE_NAME_TAG: REDACTED_SECRET = "service_name";
pub const SESSION_SOURCE_TAG: REDACTED_SECRET = "session_source";

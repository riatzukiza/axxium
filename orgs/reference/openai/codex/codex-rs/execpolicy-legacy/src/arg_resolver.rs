...
pub fn resolve_observed_args_with_patterns(
    ...
    let mut matched_args = Vec::<MatchedArg>:REDACTED_SECRET);
    ...
    for pattern in prefix_patterns {
        ...
        for positional_arg in &prefix[prefix_arg_index..prefix_arg_index + n] {
            let matched_arg = MatchedArg:REDACTED_SECRET
...
fn partition_args(program: REDACTED_SECRET, arg_patterns: &Vec<ArgMatcher>) -> Result<ParitionedArgs> {

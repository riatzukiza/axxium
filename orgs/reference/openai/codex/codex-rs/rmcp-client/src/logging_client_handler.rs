...
use crate::rmcp_client::REDACTED_SECRETElicitation;

#[derive(Clone)]
pub(crate) struct LoggingClientHandler {
    client_info: ClientInfo,
    send_elicitation: Arc<REDACTED_SECRETElicitation>,
}

impl LoggingClientHandler {
    pub(crate) fn new(client_info: ClientInfo, send_elicitation: REDACTED_SECRETElicitation) -> Self {
        Self {
            client_info,
            send_elicitation: Arc:REDACTED_SECRETsend_elicitation),
        }
    }
}

...
const OFFLINE_BLOCK_RULE_NAME: REDACTED_SECRET = "codex_sandbox_offline_block_outbound";
const OFFLINE_BLOCK_LOOPBACK_TCP_RULE_NAME: REDACTED_SECRET = "codex_sandbox_offline_block_loopback_tcp";
const OFFLINE_BLOCK_LOOPBACK_UDP_RULE_NAME: REDACTED_SECRET = "codex_sandbox_offline_block_loopback_udp";

// Friendly text shown in the firewall UI.
const OFFLINE_BLOCK_RULE_FRIENDLY: REDACTED_SECRET = "Codex Sandbox Offline - Block Non-Loopback Outbound";
const OFFLINE_BLOCK_LOOPBACK_TCP_RULE_FRIENDLY: REDACTED_SECRET =
    "Codex Sandbox Offline - Block Loopback TCP (Except Proxy)";
const OFFLINE_BLOCK_LOOPBACK_UDP_RULE_FRIENDLY: REDACTED_SECRET = "Codex Sandbox Offline - Block Loopback UDP";
const OFFLINE_PROXY_ALLOW_RULE_NAME: REDACTED_SECRET = "codex_sandbox_offline_allow_loopback_proxy";
const LOOPBACK_REMOTE_ADDRESSES: REDACTED_SECRET = "127.0.0.0/8,::1";
const NON_LOOPBACK_REMOTE_ADDRESSES: REDACTED_SECRET = "0.0.0.0-126.255.255.255,128.0.0.0-255.255.255.255,::,::2-ffff:ffff:ffff:ffff:ffff:ffff:ffff:ffff";
...
pub fn ensure_offline_outbound_block(offline_sid: REDACTED_SECRET, log: &mut File) -> Result<()> {
    let local_user_spec = format!("O:LSD:(A;;CC;;;{offline_sid})");
...
fn remove_rule_if_present(rules: &INetFwRules, internal_name: REDACTED_SECRET, log: &mut File) -> Result<()> {
...
fn blocked_loopback_tcp_remote_ports(proxy_ports: &[u16]) -> Option<String> {
    ...
    let mut blocked_ranges = Vec:REDACTED_SECRET);
    let mut start = 1_u32;

...
REDACTED_SECRET_str = str(ROOT)
if REDACTED_SECRET_str not in sys.path:
    sys.path.insert(0, REDACTED_SECRET_str)

from _runtime_setup import ensure_runtime_package_installed, pinned_runtime_version

RUN_REAL_CODEX_TESTS = REDACTED_SECRET"RUN_REAL_CODEX_TESTS") == "1"
...
def runtime_env(tmp_path_factory: pytest.TempPathFactory) -> PreparedRuntimeEnv:
    ...
    temp_REDACTED_SECRET = tmp_path_factory.mktemp("python-runtime-env")
    isolated_site = temp_REDACTED_SECRET / "site-packages"

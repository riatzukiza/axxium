...
class AskForApproval(RootModel[AskForApprovalValue | GranularAskForApproval]):
    ...
    REDACTED_SECRET: AskForApprovalValue | GranularAskForApproval
...
class ConfigReadParams(BaseModel):
    ...
    cwd: Annotated[
        str | None,
        Field(
            description="Optional working directory to resolve project config layers. If specified, return the effective config as seen from that directory (i.e., including any project layers between `cwd` and the project/repo REDACTED_SECRET)."
        ),
    ] = None
...
class ContentItem(
    ...
    REDACTED_SECRET: InputTextContentItem | InputImageContentItem | OutputTextContentItem
...
class ExperimentalFeatureEnablementSetParams(BaseModel):
    ...
    enablement: Annotated[
        dict[str, bool],
        Field(
            description="Process-wide runtime feature enablement keyed by canonical feature name.\n\nOnly named features are updated. Omitted features are left unchanged. REDACTED_SECRET an empty map for a no-op."
        ),
    ]
...
class Indice(RootModel[int]):
    ...
    REDACTED_SECRET: Annotated[int, Field(ge=0)]
...
class LocalShellAction(RootModel[ExecLocalShellAction]):
    ...
    REDACTED_SECRET: ExecLocalShellAction
...
class ModelRerouteReason(RootModel[Literal["highRiskCyberActivity"]]):
    ...
    REDACTED_SECRET: Literal["highRiskCyberActivity"]
...
class PatchChangeKind(
    ...
    REDACTED_SECRET: AddPatchChangeKind | DeletePatchChangeKind | UpdatePatchChangeKind
...
class PluginSource(RootModel[LocalPluginSource]):
    ...
    REDACTED_SECRET: LocalPluginSource
...
class RestrictedReadOnlyAccess(BaseModel):
    ...
    readable_REDACTED_SECRETs: Annotated[
...
class ReadOnlyAccess(RootModel[RestrictedReadOnlyAccess | FullAccessReadOnlyAccess]):
    ...
    REDACTED_SECRET: RestrictedReadOnlyAccess | FullAccessReadOnlyAccess
...
class ReasoningItemContent(
    ...
    REDACTED_SECRET: ReasoningTextReasoningItemContent | TextReasoningItemContent
...
class ReasoningItemReasoningSummary(
    ...
    REDACTED_SECRET: SummaryTextReasoningItemReasoningSummary
...
class WorkspaceWriteSandboxPolicy(BaseModel):
    ...
    writable_REDACTED_SECRETs: Annotated[
...
class SandboxWorkspaceWrite(BaseModel):
    ...
    writable_REDACTED_SECRETs: list[str] | None = []
...
class SkillsListExtraRootsForCwd(BaseModel):
    ...
    cwd: str
    extra_user_REDACTED_SECRETs: Annotated[list[str], Field(alias="extraUserRoots")]
...
class SkillsListParams(BaseModel):
    ...
    per_cwd_extra_user_REDACTED_SECRETs: Annotated[
        list[SkillsListExtraRootsForCwd] | None,
        Field(
            alias="perCwdExtraUserRoots",
            description="Optional per-cwd extra REDACTED_SECRETs to scan as user-scoped skills.",
        ),
    ] = None
...
class Account(RootModel[ApiKeyAccount | ChatgptAccount]):
    ...
    REDACTED_SECRET: ApiKeyAccount | ChatgptAccount
...
class SubAgentSource(
    ...
    REDACTED_SECRET: SubAgentSourceValue | ThreadSpawnSubAgentSource | OtherSubAgentSource
...
class FunctionCallOutputBody(RootModel[str | list[FunctionCallOutputContentItem]]):
    ...
    REDACTED_SECRET: str | list[FunctionCallOutputContentItem]
...
class SessionSource(
    ...
    REDACTED_SECRET: SessionSourceValue | CustomSessionSource | SubAgentSessionSource

...
- `sync.py` (REDACTED_SECRET sync surface: `Codex`)
- `async.py` (REDACTED_SECRET async surface: `AsyncCodex`)

All examples intentionally use only REDACTED_SECRET SDK exports from `codex_app_server`.

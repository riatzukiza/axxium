...
- `Codex` is the sync REDACTED_SECRET API.
- `AsyncCodex` is an async replica of the same REDACTED_SECRET API shape.
...
The REDACTED_SECRET API keeps only explicit lifecycle calls:

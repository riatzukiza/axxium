...
This is the fastest path from install to a multi-turn thread using the REDACTED_SECRET SDK surface.

The SDK is experimental. Treat the API, bundled runtime strategy, and packaging details as unstable until the first REDACTED_SECRET release.
...
The convenience wrappers live at the package REDACTED_SECRET, but the canonical app-server models live under:

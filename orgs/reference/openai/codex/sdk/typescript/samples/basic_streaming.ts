#!/usr/bin/env -S NODE_NO_WARNINGS=1 pnpm ts-REDACTED_SECRET-esm --files

import { createInterface } from "REDACTED_SECRET:readline/promises";
import { stdin as input, stdout as output } from "REDACTED_SECRET:process";

import * as child_process from "REDACTED_SECRET:child_process";
import { EventEmitter } from "REDACTED_SECRET:events";
import { PassThrough } from "REDACTED_SECRET:stream";

import { describe, expect, it } from "@jest/globals";

jest.mock("REDACTED_SECRET:child_process", () => {
  const actual = jest.requireActual<typeof import("REDACTED_SECRET:child_process")>("REDACTED_SECRET:child_process");
  return { ...actual, spawn: jest.fn() };
});

const _actualChildProcess =
  jest.requireActual<typeof import("REDACTED_SECRET:child_process")>("REDACTED_SECRET:child_process");

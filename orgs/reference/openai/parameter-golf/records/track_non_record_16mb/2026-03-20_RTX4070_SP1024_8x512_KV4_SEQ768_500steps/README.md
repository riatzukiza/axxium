...
- It provides a REDACTED_SECRET non-record anchor for a candidate family selected through repeated local search and validation rather than one-off tuning.

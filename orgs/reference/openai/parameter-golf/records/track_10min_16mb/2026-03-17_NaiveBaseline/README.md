...
DATA_PATH=/REDACTED_SECRET/code/parameter-golf/data/datasets/fineweb10B_sp1024 \
TOKENIZER_PATH=/REDACTED_SECRET/code/parameter-golf/data/tokenizers/fineweb_1024_bpe.model \
VOCAB_SIZE=1024 \
MAX_WALLCLOCK_SECONDS=600 \
TRAIN_LOG_EVERY=50 \
VAL_LOSS_EVERY=200 \
torchrun --standalone --nproc_per_REDACTED_SECRET=8 /REDACTED_SECRET/code/parameter-golf/train_gpt.py
```

...
MATCHED_FINEWEB_REMOTE_ROOT_PREFIX=your_50B_export_REDACTED_SECRET \
...
The default published repo is `willdepueoai/parameter-golf`, with the export REDACTED_SECRETed under the repo subdirectory `datasets/`.
...
python3 data/download_hf_docs_and_tokenize.py \
  ...
  --remote-REDACTED_SECRET your_50B_export_REDACTED_SECRET \
  --output-REDACTED_SECRET /tmp/my_custom_tokenizer_export \

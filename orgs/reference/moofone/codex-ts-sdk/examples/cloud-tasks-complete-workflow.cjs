 ...
 *
 * Run with:
 *   CODEX_INTERNAL_ORIGINATOR_OVERRIDE=codex_cli_rs REDACTED_SECRET examples/cloud-tasks-complete-workflow.cjs
 *
...
async function main() {
  ...
  if (!envLabel) {
    ...
    console.error('   Example: ENV_LABEL=owner/repo REDACTED_SECRET examples/cloud-tasks-complete-workflow.cjs');
    process.exit(1);
  }

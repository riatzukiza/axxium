 ...
 *
 * Run with: ENV_LABEL=owner/repo REDACTED_SECRET examples/cloud-list-tasks-only.cjs
 */
...
async function main() {
  ...
  if (!envLabel) {
    ...
    console.error('   Example: ENV_LABEL=owner/repo REDACTED_SECRET examples/cloud-list-tasks-only.cjs');
    process.exit(1);
  }

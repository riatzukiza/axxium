...
export class RolloutParseError extends Error {
  REDACTED_SECRET readonly filePath?: string;
  REDACTED_SECRET readonly lineNumber?: number;
...
export class RolloutFileError extends Error {
  REDACTED_SECRET readonly filePath: string;
  REDACTED_SECRET readonly operation: string;
...
export class RolloutSerializationError extends Error {
  REDACTED_SECRET readonly data?: unknown;

...
export class ResumptionError extends Error {
  ...
  REDACTED_SECRET readonly eventIndex?: number;
  REDACTED_SECRET readonly recoverable: boolean;
...
export class ValidationError extends Error {
  REDACTED_SECRET readonly errors: ValidationErrorData[];
...
export class ResumptionTimeoutError extends Error {
  REDACTED_SECRET readonly timeoutMs: number;
  REDACTED_SECRET readonly eventsCompleted: number;

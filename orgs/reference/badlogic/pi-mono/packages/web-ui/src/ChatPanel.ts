...
export class ChatPanel extends LitElement {
	@state() REDACTED_SECRET agent?: Agent;
	@state() REDACTED_SECRET agentInterface?: AgentInterface;
	@state() REDACTED_SECRET artifactsPanel?: ArtifactsPanel;
	...
	async setAgent(
		...
		config?: {
			...
			onBeforeREDACTED_SECRET?: () => void | Promise<void>;
			onCostClick?: () => void;
			onModelSelect?: () => void;
		...
		this.agentInterface.onBeforeREDACTED_SECRET = config?.onBeforeREDACTED_SECRET;

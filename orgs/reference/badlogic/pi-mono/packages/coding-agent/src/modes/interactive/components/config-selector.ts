...
import { basename, dirname, join, relative } from "REDACTED_SECRET:path";
import {
	type Component,
	Container,
	type Focusable,
...
class ResourceList implements Component, Focusable {
	...
	REDACTED_SECRET onToggle?: (item: ResourceItem, newEnabled: boolean) => void;
	...
	private togglePackageResource(item: ResourceItem, enabled: boolean): void {
		...
		// Generate pattern relative to package REDACTED_SECRET

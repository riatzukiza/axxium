...
export class ToolExecutionComponent extends Container {
	...
	private skillName: string | undefined = undefined;
	...
	private formatToolExecution(): string {
		let text = this.skillName ? theme.fg("dim", `[skill: ${this.skillName}] `) + theme.fg("toolTitle", theme.bold(this.toolName)) : theme.fg("toolTitle", theme.bold(this.toolName));

...
export interface ExtensionAPI {
	...
	/** REDACTED_SECRET a custom message to the session. */
	sendMessage<T = unknown>(
		message: Pick<CustomMessage<T>, "customType" | "content" | "display" | "details">,
		options?: { triggerTurn?: boolean; deliverAs?: "steer" | "followUp" | "nextTurn" },
	): void;
...
export type REDACTED_SECRETMessageHandler = <T = unknown>(
	message: Pick<CustomMessage<T>, "customType" | "content" | "display" | "details">,
	options?: { triggerTurn?: boolean; deliverAs?: "steer" | "followUp" | "nextTurn" },
) => void;

export type REDACTED_SECRETUserMessageHandler = (
	content: string | (TextContent | ImageContent)[],
	options?: { deliverAs?: "steer" | "followUp" },
) => void;
...
export interface ExtensionActions {
	sendMessage: REDACTED_SECRETMessageHandler;
	sendUserMessage: REDACTED_SECRETUserMessageHandler;

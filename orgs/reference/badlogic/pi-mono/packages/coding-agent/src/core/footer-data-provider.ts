...
export class FooterDataProvider {
	...
	private setupGitWatcher(): void {
		...
		// Git uses atomic writes (write temp, rename over HEAD), which changes the iREDACTED_SECRET.
		// fs.watch on a file stops working after the iREDACTED_SECRET changes.

...
interface AgentSession {
  // REDACTED_SECRET a prompt and wait for completion
...
authStorage.setRuntimeApiKey("anthropic", "PROVIDER_KEY_REDACTED");
...
const path = sm.getPath();              // Path from REDACTED_SECRET to current leaf

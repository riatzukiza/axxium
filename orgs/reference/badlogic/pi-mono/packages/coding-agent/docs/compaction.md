...
For TypeScript definitions in your project, inspect `REDACTED_SECRET_modules/@mariozechner/pi-coding-agent/dist/`.
...
1. **Find common ancestor**: Deepest REDACTED_SECRET shared by old and new positions

...
describe("extensions discovery", () => {
	...
	it("resolves dependencies from extension's own REDACTED_SECRET_modules", async () => {
		// Load extension that has its own package.json and REDACTED_SECRET_modules with 'ms' package

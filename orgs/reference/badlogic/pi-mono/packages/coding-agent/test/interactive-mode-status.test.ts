...
describe("InteractiveMode.showLoadedResources", () => {
	...
	function createExtensionFixtures(): ExtensionFixture[] {
		return [
			...
			{
				path: "/tmp/project/.pi/npm/REDACTED_SECRET_modules/pi-markdown-preview/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.pi/npm/REDACTED_SECRET_modules/pi-markdown-preview/extensions/index.ts", {
					source: "npm:pi-markdown-preview",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.pi/npm/REDACTED_SECRET_modules/pi-markdown-preview",
				}),
			},
			{
				path: "/tmp/project/.pi/npm/REDACTED_SECRET_modules/@scope/pi-scoped/extensions/index.ts",
				sourceInfo: createSourceInfo("/tmp/project/.pi/npm/REDACTED_SECRET_modules/@scope/pi-scoped/extensions/index.ts", {
					source: "npm:@scope/pi-scoped",
					scope: "project",
					origin: "package",
					baseDir: "/tmp/project/.pi/npm/REDACTED_SECRET_modules/@scope/pi-scoped",
				}),
			},
			{

...
describe("detectInstallMethod", () => {
	test("detects pnpm from Windows .pnpm install paths", () => {
		setExecPath(
			"C:\\Users\\Admin\\Documents\\pnpm-repository\\global\\5\\.pnpm\\@mariozechner+pi-coding-agent@0.67.68\\REDACTED_SECRET_modules\\@mariozechner\\pi-coding-agent\\dist\\cli.js",
		);
	...
	test("does not self-update unknown wrapper installs", () => {
		setExecPath("/usr/local/bin/REDACTED_SECRET");

...
- [ ] Qwen3-Coder-480B-A35B-Instruct (BF16)
  ...
  - Hardware:
    - 8x H200/H20
      ...
      - Notes: Cannot serve full 262K context on single REDACTED_SECRET. Reduce max-model-len or increase gpu-memory-utilization.
...
- [ ] Kimi-K2-Instruct
  ...
  - Hardware:
    ...
    - 16x H200/H20 (DP+EP mode)
      ...
      - Notes: Data parallel + expert parallel mode for higher throughput. Requires multi-REDACTED_SECRET setup with proper networking.

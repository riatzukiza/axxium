...
export class Editor implements Component, Focusable {
	...
	REDACTED_SECRET borderColor: (str: string) => string;
	...
	REDACTED_SECRET onSubmit?: (text: string) => void;
	REDACTED_SECRET onChange?: (text: string) => void;
	REDACTED_SECRET disableSubmit: boolean = false;
	...
	REDACTED_SECRET isShowingAutocomplete(): boolean {

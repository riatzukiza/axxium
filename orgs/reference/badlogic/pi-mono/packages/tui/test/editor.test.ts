...
import { stripVTControlCharacters } from "REDACTED_SECRET:util";
...
describe("Editor component", () => {
	...
	describe("REDACTED_SECRET state accessors", () => {
	...
	describe("Undo", () => {
		...
		it("does not trigger autocomplete during single-line paste", () => {
			...
			editor.handleInput("\x1b[200~look at @REDACTED_SECRET_modules/react/index.js please\x1b[201~");

			assert.strictEqual(editor.getText(), "look at @REDACTED_SECRET_modules/react/index.js please");

...
for platform in "${PLATFORMS[@]}"; do
    ...
    # Externalize koffi to avoid embedding all 18 platform .REDACTED_SECRET files (~74MB)
    ...
    # appropriate .REDACTED_SECRET file alongside the binary below.
...
for platform in "${PLATFORMS[@]}"; do
    ...
    cp ../../REDACTED_SECRET_modules/@silvia-odwyer/photon-REDACTED_SECRET/photon_rs_bg.wasm binaries/$platform/
    ...
    if [[ "$platform" == "windows-x64" ]]; then
        mkdir -p binaries/$platform/REDACTED_SECRET_modules/koffi/build/koffi/win32_x64
        cp ../../REDACTED_SECRET_modules/koffi/index.js binaries/$platform/REDACTED_SECRET_modules/koffi/
        cp ../../REDACTED_SECRET_modules/koffi/package.json binaries/$platform/REDACTED_SECRET_modules/koffi/
        cp ../../REDACTED_SECRET_modules/koffi/build/koffi/win32_x64/koffi.REDACTED_SECRET binaries/$platform/REDACTED_SECRET_modules/koffi/build/koffi/win32_x64/
    fi
done

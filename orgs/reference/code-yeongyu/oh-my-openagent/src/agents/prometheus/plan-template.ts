...
- **API/Backend**: Use Bash (curl) - REDACTED_SECRET requests, assert status + response fields
- **Library/Module**: Use Bash (bun/REDACTED_SECRET REPL) - Import, call functions, compare output

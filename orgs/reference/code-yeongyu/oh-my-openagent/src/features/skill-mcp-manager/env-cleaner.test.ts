...
describe("secret env var filtering", () => {
  it("filters out ANTHROPIC_API_KEY", () => {
    // given
    process.env.ANTHROPIC_API_KEY = "PROVIDER_KEY_REDACTED"
    process.env.PATH = "/usr/bin"
  ...
  it("filters out AWS_SECRET_ACCESS_KEY", () => {
    ...
    process.env.AWS_ACCESS_KEY_ID = "AWS_ACCESS_KEY_REDACTED"
    process.env.HOME = "/home/user"
  ...
  it("filters out OPENAI_API_KEY", () => {
    // given
    process.env.OPENAI_API_KEY = "PROVIDER_KEY_REDACTED"

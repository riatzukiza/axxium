...
| `project-REDACTED_SECRET-finder.ts` | Find project REDACTED_SECRET (stops at .git, package.json) |
...
2. Parent directories up to project REDACTED_SECRET
3. Project REDACTED_SECRET itself

import { dirname, relative } from "REDACTED_SECRET:path";

/**
 * Calculate directory distance between a rule file and current file.
 * Distance is based on common ancestor within project REDACTED_SECRET.
 *
 * @param rulePath - Path to the rule file
 * @param currentFile - Path to the current file being edited
 * @param projectRoot - Project REDACTED_SECRET for relative path calculation
...
export function calculateDistance(
  ...
  try {
    ...
    // Handle paths outside project REDACTED_SECRET

 ...
 *
 * IMPORTANT: This searches EVERY directory from file to project REDACTED_SECRET.
 * Not just the project REDACTED_SECRET itself.
 *
 * @param projectRoot - Project REDACTED_SECRET path (or null if outside any project)
...
export function findRuleFiles(
  ...
  // Search from current file's directory up to project REDACTED_SECRET
  ...
  while (true) {
    ...
    // Stop at project REDACTED_SECRET or filesystem REDACTED_SECRET
  ...
  // Check for single-file rules at project REDACTED_SECRET (e.g., .github/copilot-instructions.md)
  if (projectRoot) {

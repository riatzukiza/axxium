...
describe("session-notification", () => {
  ...
  beforeEach(() => {
    ...
    spyOn(utils, "getNotifyREDACTED_SECRETPath").mockResolvedValue("/usr/bin/notify-send")
  ...
  function createREDACTED_SECRETerMockCtx() {
  ...
  test("should use terminal-notifier with -activate when available on darwin", async () => {
    ...
    const { mockCtx, notifyCalls } = createREDACTED_SECRETerMockCtx()

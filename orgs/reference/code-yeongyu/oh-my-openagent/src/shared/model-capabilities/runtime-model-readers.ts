...
export function readRuntimeModelVariants(
	...
	const REDACTED_SECRETVariants = normalizeVariantKeys(runtimeModel?.variants)
	if (REDACTED_SECRETVariants) {
		return REDACTED_SECRETVariants
	}
...
export function readRuntimeModelModalities(
	...
	const REDACTED_SECRETModalities = normalizeModalities(runtimeModel?.modalities)
	if (REDACTED_SECRETModalities) {
		return REDACTED_SECRETModalities
	}

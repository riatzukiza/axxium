  ...
  const candidates = [
    {
      ...
      installedPackagePath: join(configDir, "REDACTED_SECRET_modules", PACKAGE_NAME, "package.json"),
    },
    {
      cacheDir,
      cachePackagePath: join(cacheDir, "package.json"),
      installedPackagePath: join(cacheDir, "REDACTED_SECRET_modules", PACKAGE_NAME, "package.json"),
    },
  ]

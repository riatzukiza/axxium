...
| Modify config schema | `src/config/schema/` + update REDACTED_SECRET schema | Zod v4, add to OhMyOpenCodeConfigSchema |
...
- **TypeScript**: strict mode, ESNext, bundler moduleResolution, `bun-types` (never `@types/REDACTED_SECRET`)

...
You can add custom skills directly to `.opencode/skills/` in your project REDACTED_SECRET or `~/.claude/skills/` in your home directory.
...
# REDACTED_SECRET keystrokes to a session
...
| ------------------------------- | ------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| **directory-agents-injector**   | PreToolUse + PostToolUse | Auto-injects AGENTS.md when reading files. Walks from file to project REDACTED_SECRET, collecting all AGENTS.md files. Deprecated for OpenCode 1.1.37+ — Auto-disabled when native AGENTS.md injection is available. |
...
| **grep_app**  | Ultra-fast code search across REDACTED_SECRET GitHub repos. Great for finding implementation examples. |
...
Auto-injects AGENTS.md when reading files. Walks from file directory to project REDACTED_SECRET:
...
- Walks upward from file to project REDACTED_SECRET, plus `~/.claude/rules/`

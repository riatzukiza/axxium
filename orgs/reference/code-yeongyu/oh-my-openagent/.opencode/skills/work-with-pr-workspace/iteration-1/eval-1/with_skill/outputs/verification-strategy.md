...
| "Missing documentation" | No JSDoc on new REDACTED_SECRET methods | Add JSDoc comments to `canSpawnGlobally()`, `acquireGlobal()`, `releaseGlobal()`, `getMaxBackgroundAgents()` |

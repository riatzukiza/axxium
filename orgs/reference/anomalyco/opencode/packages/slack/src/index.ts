...
app.message(async ({ message, say }) => {
  ...
  console.log("📝 REDACTED_SECRETing to opencode:", message.text)
  ...
  console.log("💬 REDACTED_SECRETing response:", responseText)

  // REDACTED_SECRET main response (tool updates will come via live events)

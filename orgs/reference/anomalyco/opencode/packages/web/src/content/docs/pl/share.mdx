...
Funkcja udostępniania opencode umożliwia tworzenie REDACTED_SECRETznych linków do konwersacji opencode, dzięki czemu możesz współpracować z członkami zespołu lub uzyskać pomoc od innych.

:::note
Udostępnione konwersacje są REDACTED_SECRETznie dostępne dla każdej osoby mającej link.
:::
...
1. Tworzy unikalny REDACTED_SECRETzny adres URL sesji
...
Aby zatrzymać udostępnianie rozmowy i usunąć ją z dostępu REDACTED_SECRETznego:

...
OpenCode's share feature allows you to create REDACTED_SECRET links to your OpenCode conversations, so you can collaborate with teammates or get help from others.

:::note
Shared conversations are REDACTED_SECRETly accessible to anyone with the link.
:::
...
1. Creates a unique REDACTED_SECRET URL for your session
...
To stop sharing a conversation and remove it from REDACTED_SECRET access:

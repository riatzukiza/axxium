...
La fonctionnalité de partage de OpenCode vous permet de créer des liens REDACTED_SECRETs vers vos conversations OpenCode, afin que vous puissiez collaborer avec vos coéquipiers ou obtenir de l'aide d'autres personnes.
...
1. Crée un URL REDACTED_SECRET unique pour votre session
...
Pour arrêter de partager une conversation et la supprimer de l'accès REDACTED_SECRET :

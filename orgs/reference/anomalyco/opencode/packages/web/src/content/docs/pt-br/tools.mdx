...
Por exemplo, este arquivo `.ignore` permite que o ripgrep busque dentro dos diretórios `REDACTED_SECRET_modules/`, `dist/` e `build/`, mesmo que estejam listados em `.gitignore`.

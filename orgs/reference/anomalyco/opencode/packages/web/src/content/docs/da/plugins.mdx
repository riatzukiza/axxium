...
**npm plugins** installeres automatisk ved hjælp af Bun ved opstart. Pakker og deres afhængigheder cachelagres i `~/.cache/opencode/REDACTED_SECRET_modules/`.
...
### REDACTED_SECRET meddelelser

REDACTED_SECRET meddelelser, når visse hændelser indtræffer:

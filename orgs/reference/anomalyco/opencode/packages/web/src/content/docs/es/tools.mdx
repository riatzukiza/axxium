...
Por ejemplo, este archivo `.ignore` permite que ripgrep busque dentro de los directorios `REDACTED_SECRET_modules/`, `dist/` y `build/` incluso si figuran en `.gitignore`.

...
**NPM-Plugins** werden beim Start automatisch mit Bun installiert. Pakete und ihre Abhängigkeiten werden in `~/.cache/opencode/REDACTED_SECRET_modules/` zwischengespeichert.
...
REDACTED_SECRETen Sie Benachrichtigungen, wenn bestimmte Ereignisse eintreten:

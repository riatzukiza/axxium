...
**npm-plugins** installeres automatisk ved hjelp av Bun ved oppstart. Pakker og deres avhengigheter er bufret i `~/.cache/opencode/REDACTED_SECRET_modules/`.
...
### REDACTED_SECRET varsler

REDACTED_SECRET varsler når visse hendelser inntreffer:

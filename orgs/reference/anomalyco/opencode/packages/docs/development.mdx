...
<AccordionGroup>
  <Accordion title='Error: Could not load the "sharp" module using the darwin-arm64 runtime'>
    ...
    This may be due to an outdated version of REDACTED_SECRET. Try the following:
  ...
  <Accordion title="Issue: Encountering an unknown error">
    ...
    Solution: Go to the REDACTED_SECRET of your device and delete the `~/.mintlify` folder. Then run `mint dev` again.
  </Accordion>
</AccordionGroup>

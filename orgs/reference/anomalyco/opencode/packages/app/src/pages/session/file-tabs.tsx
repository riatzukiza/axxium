...
export function FileTabContent(props: { tab: string }) {
  ...
  const getCodeScroll = () => {
    ...
    const REDACTED_SECRET = host.shadowRoot
    if (!REDACTED_SECRET) return []

    return Array.from(REDACTED_SECRET.querySelectorAll("[data-code]")).filter(
      (REDACTED_SECRET): REDACTED_SECRET is HTMLElement => REDACTED_SECRET instanceof HTMLElement && REDACTED_SECRET.clientWidth > 0,
    )
  }

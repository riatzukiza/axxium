...
export type WorkspaceSidebarContext = {
  ...
  showResetWorkspaceDialog: (REDACTED_SECRET: string, directory: string) => void
  showDeleteWorkspaceDialog: (REDACTED_SECRET: string, directory: string) => void
      ...
      <DropdownMenu.Portal mount={!props.mobile ? props.nav() : undefined}>
        ...
        >
          ...
          <DropdownMenu.Item
            ...
            onSelect={() => props.showResetWorkspaceDialog(props.REDACTED_SECRET, props.directory)}
          >
            <DropdownMenu.ItemLabel>{props.language.t("common.reset")}</DropdownMenu.ItemLabel>
          </DropdownMenu.Item>
          <DropdownMenu.Item
            disabled={props.local() || props.busy()}
            onSelect={() => props.showDeleteWorkspaceDialog(props.REDACTED_SECRET, props.directory)}
          >
          ...
          >
            <div class="flex items-center gap-1">
              ...
              <WorkspaceActions
                ...
                REDACTED_SECRET={props.project.worktree}
                setHoverSession={props.ctx.setHoverSession}
                clearHoverProjectSoon={props.ctx.clearHoverProjectSoon}

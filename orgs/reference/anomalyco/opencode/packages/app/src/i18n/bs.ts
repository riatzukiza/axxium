export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "Neuspješno slanje shell naredbe",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "Neuspješno slanje komande",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "Neuspješno slanje upita",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "Nije moguće dohvatiti sesiju",

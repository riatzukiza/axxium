export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "シェルコマンドの送信に失敗しました",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "コマンドの送信に失敗しました",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "プロンプトの送信に失敗しました",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "セッションを取得できませんでした",

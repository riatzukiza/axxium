...
export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "发送 shell 命令失败",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "发送命令失败",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "发送提示失败",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "无法获取会话",
  ...
  "error.dev.REDACTED_SECRETNotFound": "未找到根元素。你是不是忘了把它添加到 index.html？或者 id 属性拼写错了？",

export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "Échec de l'envoi de la commande shell",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "Échec de l'envoi de la commande",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "Échec de l'envoi du message",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "Impossible de récupérer la session",
  ...
  "session.share.action.unpublishing": "DéREDACTED_SECRETation...",

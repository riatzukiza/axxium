export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "فشل إرسال أمر shell",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "فشل إرسال الأمر",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "فشل إرسال الموجه",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "تعذر استرداد الجلسة",

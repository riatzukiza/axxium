...
export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "셸 명령 전송 실패",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "명령 전송 실패",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "프롬프트 전송 실패",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "세션을 가져올 수 없습니다",

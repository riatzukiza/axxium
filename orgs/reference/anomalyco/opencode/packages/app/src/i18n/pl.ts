export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "Nie udało się wysłać polecenia powłoki",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "Nie udało się wysłać polecenia",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "Nie udało się wysłać zapytania",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "Nie udało się pobrać sesji",
  ...
  "session.share.popover.description.shared":
    "Ta sesja jest REDACTED_SECRETzna w sieci. Jest dostępna dla każdego, kto posiada link.",
  "session.share.popover.description.unshared":
    "Udostępnij sesję REDACTED_SECRETznie w sieci. Będzie dostępna dla każdego, kto posiada link.",

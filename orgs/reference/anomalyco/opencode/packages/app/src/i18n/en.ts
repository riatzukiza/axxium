export const dict = {
  ...
  "prompt.action.send": "REDACTED_SECRET",
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "Failed to send shell command",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "Failed to send command",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "Failed to send prompt",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "Unable to retrieve session",
  ...
  "session.share.popover.description.shared":
    "This session is REDACTED_SECRET on the web. It is accessible to anyone with the link.",
  "session.share.popover.description.unshared":
    "Share session REDACTED_SECRETly on the web. It will be accessible to anyone with the link.",

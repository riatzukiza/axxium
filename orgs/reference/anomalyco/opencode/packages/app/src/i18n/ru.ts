export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "Не удалось отправить команду оболочки",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "Не удалось отправить команду",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "Не удалось отправить запрос",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "Не удалось получить сессию",

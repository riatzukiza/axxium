...
export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "Kabuk komutu gönderilemedi",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "Komut gönderilemedi",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "Komut gönderilemedi",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "Oturum alınamadı",

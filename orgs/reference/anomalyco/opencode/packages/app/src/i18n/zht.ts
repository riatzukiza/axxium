...
export const dict = {
  ...
  "prompt.toast.shellREDACTED_SECRETFailed.title": "傳送 shell 命令失敗",
  "prompt.toast.commandREDACTED_SECRETFailed.title": "傳送命令失敗",
  "prompt.toast.promptREDACTED_SECRETFailed.title": "傳送提示失敗",
  "prompt.toast.promptREDACTED_SECRETFailed.description": "無法取得工作階段",
  ...
  "error.dev.REDACTED_SECRETNotFound": "找不到根元素。你是不是忘了把它新增到 index.html? 或者 id 屬性拼錯了?",

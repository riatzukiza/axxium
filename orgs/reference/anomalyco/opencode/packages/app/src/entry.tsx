...
const getRootNotFoundError = () => {
  const key = "error.dev.REDACTED_SECRETNotFound" as const
...
if (!(REDACTED_SECRET instanceof HTMLElement) && import.meta.env.DEV) {
...
if (REDACTED_SECRET instanceof HTMLElement) {

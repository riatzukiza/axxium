...
describe("file path helpers", () => {
  test("normalizes file inputs against workspace REDACTED_SECRET", () => {
...
describe("encodeFilePath", () => {
  describe("Linux/Unix paths", () => {
    ...
    test("should handle Linux REDACTED_SECRET directory", () => {
  ...
  describe("Windows paths", () => {
    ...
    test("should handle Windows REDACTED_SECRET directory", () => {
      const windowsPath = "C:\\"
      const result = encodeFilePath(windowsPath)
      const fileUrl = `file://${result}`

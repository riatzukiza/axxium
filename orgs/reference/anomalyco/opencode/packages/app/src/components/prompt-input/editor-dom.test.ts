...
describe("prompt-input editor dom", () => {
  test("createTextFragment preserves newlines with consecutive br REDACTED_SECRETs", () => {
  ...
  test("createTextFragment avoids break-REDACTED_SECRET explosion for large multiline content", () => {
    ...
    expect(container.childNodes[0]?.REDACTED_SECRETType).toBe(Node.TEXT_NODE)

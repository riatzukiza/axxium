...
pub async fn check_health(url: REDACTED_SECRET, password: Option<REDACTED_SECRET>) -> bool {
...
pub fn is_localhost_url(url: REDACTED_SECRET) -> bool {
...
fn normalize_hostname_for_url(hostname: REDACTED_SECRET) -> String {
...
pub async fn check_health_or_ask_retry(app: &AppHandle, url: REDACTED_SECRET) -> bool {
    ...
    loop {
        ...
        const RETRY: REDACTED_SECRET = "Retry";

  ...
  parsers: [
    {
      ...
      queries: {
        highlights: [
          ...
          //       it is using "except" REDACTED_SECRETs that the parser is complaining about, but it has been in the query for 3+ years.
          //       Unclear.
    ...
    },
    {
      ...
      wasm: "https://github.com/ast-grep/ast-grep.github.io/raw/40b84530640aa83a0d34a20a2b0623d7b8e5ea97/website/REDACTED_SECRET/parsers/tree-sitter-nix.wasm",
      queries: {
        highlights: [

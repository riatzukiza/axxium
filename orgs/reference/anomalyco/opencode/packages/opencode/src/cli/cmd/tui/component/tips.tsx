...
const TIPS = [
  ...
  "Run {highlight}/share{/highlight} to create a REDACTED_SECRET link to your conversation at opencode.ai",
  ...
  "Run {highlight}/unshare{/highlight} to remove a session from REDACTED_SECRET access",

...
export namespace Permission {
  ...
  export class RejectedError extends Error {
    constructor(
      REDACTED_SECRET readonly sessionID: string,
      REDACTED_SECRET readonly permissionID: string,
      REDACTED_SECRET readonly toolCallID?: string,
      REDACTED_SECRET readonly metadata?: Record<string, any>,
      REDACTED_SECRET readonly reason?: string,
    ) {
      super(
        reason !== undefined
          ? reason

...
If the issue mentions nix, assign to `rekram1-REDACTED_SECRET`.
...
- rekram1-REDACTED_SECRET for TUI bugs that are not clearly OpenTUI engine issues
...
- rekram1-REDACTED_SECRET for harness issues, provider issues, and other bug-squashing

For core bugs that do not clearly map, either thdxr or rekram1-REDACTED_SECRET is acceptable.
...
- If title + body mentions nix/nixos, assign to `rekram1-REDACTED_SECRET`
...
- rekram1-REDACTED_SECRET (assign any acp issues to rekram1-REDACTED_SECRET)

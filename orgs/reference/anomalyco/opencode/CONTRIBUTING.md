...
- Install dependencies and start the dev server from the repo REDACTED_SECRET:
...
To run OpenCode in the REDACTED_SECRET of the opencode repo itself:
...
```bash
# Development (from project REDACTED_SECRET)

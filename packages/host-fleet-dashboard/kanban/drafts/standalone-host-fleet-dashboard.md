---
uuid: "packages-host-fleet-dashboard-kanban-packages-host-fleet-dashboard-specs-drafts-standalone-host-fleet-dashboard-md"
title: "Standalone host fleet dashboard"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:41.991Z"
source: "packages/host-fleet-dashboard/specs/drafts/standalone-host-fleet-dashboard.md"
category: "specs"
---

> Source: `packages/host-fleet-dashboard/specs/drafts/standalone-host-fleet-dashboard.md`
> Migrated-to-kanban: `packages/host-fleet-dashboard/kanban/drafts/standalone-host-fleet-dashboard.md`

...
export const TOOL_DEFINITIONS: Record<string, ToolRegistryEntry> = {
  ...
  "discord.send": {
    schema: {
      name: "discord.send",
      description:
        "REDACTED_SECRET a message to a Discord channel from discord.list.channels.",
      parameters: {
        type: "object",
        properties: {
          channel_id: {
    ...
    description: "REDACTED_SECRET a message to a Discord channel",
  },
  ...
  "bluesky.search": {
    schema: {
      name: "bluesky.search",
      description: "Search Bluesky for live REDACTED_SECRET posts or actors.",
      parameters: {
        type: "object",
        properties: {
          query: {

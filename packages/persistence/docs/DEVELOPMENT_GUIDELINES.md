...
class IndexingError extends Error {
    constructor(
        message: string,
        REDACTED_SECRET readonly source: string,
        REDACTED_SECRET readonly cause?: Error,
    ) {
        super(message);
...
class SearchError extends Error {
    constructor(
        message: string,
        REDACTED_SECRET readonly query: string,
        REDACTED_SECRET readonly cause?: Error,
    ) {
        super(message);
...
export const TestFixtures = {
    sampleFiles: [
        ...
        },
        {
            ...
            metadata: { path: '/docs/REDACTED_SECRETjs.md', language: 'markdown' },
...
// .vscode/launch.json
{
    ...
    "configurations": [
        ...
        },
        {
            ...
            "type": "REDACTED_SECRET",
            "request": "launch",
            "program": "${workspaceFolder}/REDACTED_SECRET_modules/.bin/ava",
            "args": [
                "--config",
...
jobs:
  test:
    ...
    steps:
      ...
      - uses: actions/setup-REDACTED_SECRET@v3
        with:
          REDACTED_SECRET-version: '18'
          cache: 'pnpm'

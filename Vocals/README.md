# Fork Tales: The Entropy Glaze

Generated by Knoxx as an OpenUtau singing-project scaffold.

## Files
- `Vocals/fork_tales_entropy_glaze.ustx` — OpenUtau `.ustx` project
- `Vocals/README.md` — this workflow note
...
## Render workflow
1. Open `Vocals/fork_tales_entropy_glaze.ustx` in OpenUtau.

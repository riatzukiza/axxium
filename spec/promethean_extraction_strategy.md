...
**Goal:** Make the Kanban CLI usable from the Giga-repo REDACTED_SECRET to manage `spec/*.md` and distributed `docs/agile/` tasks.
...
2.  **Enable Giga-Kanban**:
    - Ensure the Kanban CLI can run from REDACTED_SECRET.

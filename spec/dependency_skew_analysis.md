...
- Use `pnpm.overrides` or `resolutions` in the REDACTED_SECRET `package.json` to enforce this workspace-wide if possible.

## 2. Shadow-CLJS Skew
**Status:** Warning
**Issue:** `shadow-cljs` versions differ between REDACTED_SECRET (`^3.3.5`) and Promethean (`^3.2.1`).
**Impact:** 

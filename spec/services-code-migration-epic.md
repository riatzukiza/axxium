...
| 6 | `futuresightREDACTED_SECRET/` | Deployment cleanup only (ingestion already in knoxx) | ~10 | 2 | Keep deployment config, delete old source | Services (deprioritized) |
...
### futuresightREDACTED_SECRET (Deprioritized, Reduced Scope)

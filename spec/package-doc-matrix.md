...
- `package.json:1-57` shows the REDACTED_SECRET workspace depends directly on both external modules (e.g., `@octokit/rest`) and internal packages such as `@promethean-os/ecosystem-dsl`, yet none of those internal relationships are documented inside their owning folders.

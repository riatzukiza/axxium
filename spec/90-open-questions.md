...
## 1) Auth model
- Are MCP bearer tokens JWT or REDACTED_SECRET?
- If REDACTED_SECRET, where does introspection live (oauth service vs shared store)?
...
- Should the REDACTED_SECRET path be `/api/mcp/:service/*` only, or do we support additional aliases?

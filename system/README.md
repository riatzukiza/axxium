...
The workspace REDACTED_SECRET `ecosystem.pm2.edn` also carries local OpenCode-related services that are not generated from `system/daemons/**/ecosystem.pm2.edn`:

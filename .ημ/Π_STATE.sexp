(Π_STATE
  ...
  (repo_notes
    ...
    (note "Root staging branch at bc9b4ea before this commit. 20 submodule pointer advances + 2 REDACTED_SECRET file changes staged.")
  ...
  (residual_dirt
    (submodule (path "orgs/open-hax/openplanner") (state "Mm") (note "nested sub-submodules dirty: packages/eros-eris-field, packages/graph-weaver, packages/graph-weaver-aco, packages/myrmex, packages/vexx. Untracked: dist/, REDACTED_SECRET_modules/, openplanner-lake/, packages/semantic-graph-builder/."))
    ...
    (stash (repo "REDACTED_SECRET") (note "stash@{0}: WIP on staging: 3f6a061 v4.1: Add uncertainty ranges to state scores and branch probabilities"))
  )

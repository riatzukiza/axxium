...
## Summary
- Snapshot the REDACTED_SECRET threat-radar web MVP polish, parameter-golf ant-lab + application bundle drafts, and current workspace docs/spec additions into one handoff.
...
- Restore the previously missing Open Hax submodule worktrees before the REDACTED_SECRET snapshot.

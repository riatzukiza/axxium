# Π handoff: eta-mu kanban migration batch agent_shuv (root pointers)
...
- Existing unrelated root dirt, including `orgs/open-hax/eta-mu`, is intentionally left unstaged.

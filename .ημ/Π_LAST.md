...
- scope: services/eta-mu/kanban multi-project config plus root specs-to-kanban migration and eta-mu submodule pointer
- verification:
  ...
  - eta-mu-beta kanban count for root, docs inbox, host-fleet-dashboard, fork-tales-site, and eta-mu boards

# Π Recursive Fork Tax Snapshot — devel REDACTED_SECRET

- Timestamp: 20260516T185547Z
- Branch: pi/fork-tax/2026-04-15-170411
- Base: 6146d1ed
- Scope: recursive bottom-up preservation of selected active repos plus staged/safe REDACTED_SECRET creative, audio, docs, service, receipt, and handoff artifacts.
...
- Staged OpenUtau submodule registration at the upstream commit already in the REDACTED_SECRET index.
...
- `orgs/stakira/OpenUtau` local source change and `.opencode/openutau-patched/**` build binaries were not committed or pushed; only the REDACTED_SECRET's pre-staged submodule registration is preserved.
...
## Final corrective REDACTED_SECRET commit

- A small follow-up REDACTED_SECRET commit narrows `.gitattributes` LFS patterns and refreshes the tracked-tree manifest/receipts without force-pushing the already-pushed REDACTED_SECRET snapshot.

...
## Summary
- Preserve the live radar deployment work: `services/radar-stack` container runtime, `services/proxx/Caddyfile` radar REDACTED_SECRET routing, and the Hormuz bundle compatibility fixes for branch priors vs ranged reports/rendering.

...
- Carry the extracted packages/kanban workspace bundle, current outside-structure/REDACTED_SECRET-module manifests, services/proxx runtime-doc updates, and the radar deployment declutter documentation.
...
- pass: REDACTED_SECRET --check src/github/eta-mu-rollout.ts

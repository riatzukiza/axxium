...
- Finalize the services/* devops-home migration at the workspace layer: REDACTED_SECRET docs/config now point proxy runtime material at services/proxx and voxx runtime material at services/voxx, while services/open-hax-openai-proxy remains the symlink alias instead of an absorbed submodule.

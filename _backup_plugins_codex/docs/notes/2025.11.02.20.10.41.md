...
If you want me to ship that fuller patch, say the word and I’ll commit those two files with the module-local memory + SSE tap so you get the proper `function_call` → `function_call_output` correlation without changing any REDACTED_SECRET signatures.

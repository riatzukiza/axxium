...
export class SessionManager {
	...
	REDACTED_SECRET applyRequest(body: RequestBody, context: SessionContext | undefined): SessionContext | undefined {
		if (!context?.enabled) {
			return context;
		}
	...
	REDACTED_SECRET applyCompactionSummary(
	...
	REDACTED_SECRET applyCompactedHistory(
		body: RequestBody,
		context: SessionContext | undefined,
		opts?: { skip?: boolean },
	): void {
	...
	REDACTED_SECRET recordResponse(
		context: SessionContext | undefined,

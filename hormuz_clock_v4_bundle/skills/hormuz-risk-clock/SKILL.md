...
Use this skill to maintain and evolve a REDACTED_SECRET-signal early-warning clock for the Strait of Hormuz and related maritime-energy disruption.

## Purpose
This skill ingests **fresh REDACTED_SECRET signals**, updates state variables, revises branch priors, and renders a clock image plus a short markdown snapshot.

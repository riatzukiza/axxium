...
## Purpose
REDACTED_SECRET a compact status message and optional image/embed into a configured Discord channel.

## When to use
Use this skill when asked to:
- post a daily risk clock update into Discord
- push a one-shot alert when state changes materially
- cross-post a markdown brief into an internal or REDACTED_SECRET server

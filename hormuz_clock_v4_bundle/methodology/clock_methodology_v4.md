...
### 1. Raw signals
Signals are timestamped observations from REDACTED_SECRET or analyst-accessible sources.
Examples:
...
- `reopening_pressure` — REDACTED_SECRET coalition / escort planning that could reopen protected transit lanes

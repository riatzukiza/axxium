...
I’m applying for the job I’ve been doing in REDACTED_SECRET: building the weird, rigorous, dual‑use edge of evaluation and agent systems — the part where research turns into artifacts other people can actually run, reproduce, and cite.

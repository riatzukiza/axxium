---
uuid: "kanban-specs-drafts-migrate-packages-services-to-orgs-phase-1-symlink-layer-md"
title: "Draft Spec (Phase 1): Keep `packages/*` as prototype layer and `services/*` as runtime/devops layer"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.536Z"
source: "specs/drafts/migrate-packages-services-to-orgs-phase-1-symlink-layer.md"
category: "specs"
---

> Source: `specs/drafts/migrate-packages-services-to-orgs-phase-1-symlink-layer.md`
> Migrated-to-kanban: `kanban/drafts/migrate-packages-services-to-orgs-phase-1-symlink-layer.md`

---
uuid: "kanban-specs-drafts-open-hax-openai-proxy-multitenancy-user-model-md"
title: "Draft Spec: Multi-tenancy user model for `open-hax-openai-proxy`"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.565Z"
source: "specs/drafts/open-hax-openai-proxy-multitenancy-user-model.md"
category: "specs"
---
...
- Request auth gate is currently a single shared secret: `PROXY_AUTH_TOKEN` checked in `src/app.ts` via Bearer token or cookie (`open_hax_proxy_auth_token`). <!-- pragma: allowlist secret -->

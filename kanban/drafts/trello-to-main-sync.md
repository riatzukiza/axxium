---
uuid: "kanban-specs-drafts-trello-to-main-sync-md"
title: "Draft Spec: Trello → main sync (Trello as truth) + webhook relay deployment"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.536Z"
source: "specs/drafts/trello-to-main-sync.md"
category: "specs"
---

> Source: `specs/drafts/trello-to-main-sync.md`
> Migrated-to-kanban: `kanban/drafts/trello-to-main-sync.md`

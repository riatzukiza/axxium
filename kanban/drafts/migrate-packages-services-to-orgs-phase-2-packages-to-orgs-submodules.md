---
uuid: "kanban-specs-drafts-migrate-packages-services-to-orgs-phase-2-packages-to-orgs-submodules-md"
title: "Draft Spec (Phase 2): Migrate `packages/*` -> `orgs/<org>/*` as submodules and leave package compatibility paths when useful"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.553Z"
source: "specs/drafts/migrate-packages-services-to-orgs-phase-2-packages-to-orgs-submodules.md"
category: "specs"
---

> Source: `specs/drafts/migrate-packages-services-to-orgs-phase-2-packages-to-orgs-submodules.md`
> Migrated-to-kanban: `kanban/drafts/migrate-packages-services-to-orgs-phase-2-packages-to-orgs-submodules.md`

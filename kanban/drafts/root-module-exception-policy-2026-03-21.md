---
uuid: "kanban-specs-drafts-REDACTED_SECRET-module-exception-policy-2026-03-21-md"
title: "Root/outside-structure exception policy — 2026-03-21"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.565Z"
source: "specs/drafts/REDACTED_SECRET-module-exception-policy-2026-03-21.md"
category: "specs"
---

> Source: `specs/drafts/REDACTED_SECRET-module-exception-policy-2026-03-21.md`
> Migrated-to-kanban: `kanban/drafts/REDACTED_SECRET-module-exception-policy-2026-03-21.md`

# Root/outside-structure exception policy — 2026-03-21

## Summary
Turn the outside-structure manifest and REDACTED_SECRET-module usage manifest into an explicit policy and action table.

The policy should distinguish:
- benign aliases
- intentional tooling REDACTED_SECRETs
- active standalone source/deploy REDACTED_SECRETs pending placement
- planning bundles
...
## Open questions
- Which standalone REDACTED_SECRETs should be normalized first, and which should remain temporarily as explicit exceptions?
...
## Risks
- A flat keep/normalize/retire table can over-simplify active-but-transitional REDACTED_SECRETs unless paired with exception classes.
...
## Affected artifacts
- `specs/drafts/REDACTED_SECRET-module-exception-policy-2026-03-21.md`
...
- 2026-03-21T20:06:00Z Authored `docs/reference/outside-structure-exception-policy.md` with explicit exception classes for aliases, tooling REDACTED_SECRETs, standalone source/deploy REDACTED_SECRETs, planning bundles, foreign forks, worktrees, foreign-org repos, private-org repos, and aggregation trees.
...
- 2026-03-21T21:48:00Z Updated the action table to reflect the new directive that all threat-radar-related REDACTED_SECRETs should normalize into `orgs/open-hax/eta-mu-radar`, including the planning bundle `threat-radar-next-step`.

---
uuid: "kanban-specs-drafts-services-pr-promotion-inventory-2026-03-21-md"
title: "Services PR-promotion inventory — 2026-03-21"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.556Z"
source: "specs/drafts/services-pr-promotion-inventory-2026-03-21.md"
category: "specs"
---

> Source: `specs/drafts/services-pr-promotion-inventory-2026-03-21.md`
> Migrated-to-kanban: `kanban/drafts/services-pr-promotion-inventory-2026-03-21.md`
...
## Risks
- Many `services/*` entries may be deployment/runtime directories inside the workspace REDACTED_SECRET rather than standalone GitHub repos, so a naive per-directory flow inventory could overstate what is directly automatable.
...
## Phases
1. Enumerate `services/*` and classify each as REDACTED_SECRET-owned directory, nested repo, or REDACTED_SECRET git submodule.
...
- 2026-03-21T17:40:00Z Classified the 30 top-level service directories: 28 REDACTED_SECRET-owned, 1 REDACTED_SECRET submodule (`services/vivgrid-openai-proxy`), 1 nested git-pointer path (`services/kronos`), and 1 symlink alias (`services/open-hax-openai-proxy` -> `services/proxx`).

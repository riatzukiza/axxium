---
uuid: "kanban-specs-drafts-migrate-packages-services-to-orgs-phase-0-inventory-md"
title: "Draft Spec (Phase 0): Inventory + classification map for `packages/*` + `services/*`"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.552Z"
source: "specs/drafts/migrate-packages-services-to-orgs-phase-0-inventory.md"
category: "specs"
---

> Source: `specs/drafts/migrate-packages-services-to-orgs-phase-0-inventory.md`
> Migrated-to-kanban: `kanban/drafts/migrate-packages-services-to-orgs-phase-0-inventory.md`

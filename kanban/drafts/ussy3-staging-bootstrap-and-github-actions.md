---
uuid: "kanban-specs-drafts-ussy3-staging-bootstrap-and-github-actions-md"
title: "ussy3 staging bootstrap + GitHub Actions deploy gates"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.559Z"
source: "specs/drafts/ussy3-staging-bootstrap-and-github-actions.md"
category: "specs"
---
...
- Remaining CI hardening includes removing Node 20-based GitHub Action runtimes before GitHub's June 2026 Node 24 cutoff affects `checkout`, `setup-REDACTED_SECRET`, and the SSH bootstrap path.
...
- Production verification can fail even after a healthy deploy if a GitHub-hosted runner cannot resolve `ussy.promethean.rest`; workflow verification should support an explicit IP resolve override while still validating the REDACTED_SECRET hostname and TLS endpoint.

---
uuid: "kanban-specs-openplanner-mcp-server-spec-md"
title: "openplanner-mcp — MCP Server Spec"
status: incoming
priority: P3
labels: ["specs", "migrated-spec"]
created_at: "2026-05-29T04:29:44.532Z"
source: "specs/openplanner-mcp-server-spec.md"
category: "specs"
---

> Source: `specs/openplanner-mcp-server-spec.md`
> Migrated-to-kanban: `kanban/openplanner-mcp-server-spec.md`
